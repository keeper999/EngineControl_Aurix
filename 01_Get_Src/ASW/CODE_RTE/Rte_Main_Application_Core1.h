#if !defined(RTE_MAIN_APPLICATION_CORE1_H)
#define RTE_MAIN_APPLICATION_CORE1_H
...
extern FUNC(Std_ReturnType, RTE_CODE) Rte_Start_Application_Core1(void);

/** \brief Rte_Stop lifecycle API function  */
extern FUNC(Std_ReturnType, RTE_CODE) Rte_Stop_Application_Core1(void);
...
#endif /* !defined(RTE_MAIN_APPLICATION_CORE1_H) */
/*==================[end of file]============================================*/
