...
/* !Description     : AFA Software Component                                  */
/*                                                                            */
/* !File            : AFA_F04_add_egr_reference_noise.c                       */
/*                                                                            */
...
#include "AFA_F04_add_egr_reference_noise_private.h"
#include "AFAT.h"
...
/* Output and update for referenced model: 'AFA_F04_add_egr_reference_noise' */
void mr_AFA_F04_add_egr_reference_no(const UInt16 rtu_AFA_prm_covNoise3[8],
  UInt16 rty_AFA_prm_covN[8])
{
  ...
  /* Constant: '<Root>/AFA_covNoiseValClsEGRInc_C' */
  localMatrixConcatenation[7] = AFA_covNoiseValClsEGRInc_C;
...
void mr_AFA_F04_add_egr_r_initialize(void)
{
