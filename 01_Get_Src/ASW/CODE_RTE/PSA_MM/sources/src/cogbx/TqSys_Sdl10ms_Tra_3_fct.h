 ...
 *** *******************************************************************************
 *** 
 ***  %name: TqSys_Sdl10ms_Tra_3_fct.h %
 *** 
 ***  %version: 11.0.build1 %
 *** 
 ***  %date_modified: Wed Apr 24 15:33:35 2013 %
 *** 
 *** 
 ***  %derived_by: u383015 %
 ***  %release: TqStruct/10.1 %
 ***  %full_filespec: TqSys_Sdl10ms_Tra_3_fct.h-11.0.build1:incl:3 %
 *** 
 *** *******************************************************************************
 *** 
 *** Simulink model       : CSMT_CGMT06_2096
 *** TargetLink subsystem : CSMT_CGMT06_2096/F0_CSMT_CGMT06_2096_V7_0
 *** Codefile             : tqsys_sdl10ms_tra_3_fct.h
 ***
...
#ifndef _TQSYS_SDL10MS_TRA_3_FCT_H_
#define _TQSYS_SDL10MS_TRA_3_FCT_H_
...
\******************************************************************************/
extern Void TqSys_Sdl10ms_Tra_3_fct(Void);


#endif/*_TQSYS_SDL10MS_TRA_3_FCT_H_ */
/*----------------------------------------------------------------------------*\
  END OF FILE
\*----------------------------------------------------------------------------*/
