...
/******************************************************************************/
/*! \Description    PduR_LinIfRxIndication\n
    \return         void \n
    ...
    P2VAR(PduInfoType, AUTOMATIC, PDUR_APPL_DATA)   PduInfoPtr)
{
    ...
    #if(PduR_u16LINIF_RX_MINRT_SIZE > 0UL && PduR_bIFUP_ENABLED == STD_ON)
    strRxTablesRef.pkstrMinRRxTRf           = PduR_akstreLinIfRxMinRT;
    ...
    strRxTablesRef.u16MinRxTSize            = PduR_ku16eLinIfRxMinRTSize;
    strRxTablesRef.u8APIId                  = PduR_u8LINIFRXINDICATION;

    if(PduR_u8eState == PDUR_ONLINE)
    {
        #if(PduR_u8NUMBER_OF_PB_CONFIGS > 0UL)
        strRxTablesRef.pkstrNrmRRxTRf       = PduR_pkstrePbCfg->pkstrLinIfRxRTable;
        strRxTablesRef.pkstrNrmRxFnTblRf    = PduR_pkstrePbCfg->pkstrIf2UpRxFuncTable;
        strRxTablesRef.u16NrmRxTSize        = PduR_pkstrePbCfg->u16LinIfRxRTSize;
        #else
...
/******************************************************************************/
/*! \Description    PduR_LinIfTxConfirmation \n
    \return         void \n
    \Trace_to       PduR-CDD-0197(0), PduR-CDD-0198(0)
*******************************************************************************/
    ...
    VAR(PduIdType, AUTOMATIC)                       TxPduId)
{
    ...
    #if(PduR_u16LINIF_TX_MINRT_SIZE > 0UL && PduR_bIFUP_ENABLED == STD_ON)
    strTxTablesRef.pkstrMinRTxTRf           = PduR_akstreLinIfTxMinRT;
    ...
    strTxTablesRef.u16MinTxTSize            = PduR_ku16eLinIfTxMinRTSize;
    strTxTablesRef.u8APIId                  = PduR_u8LINIFTXCONFIRMATION;

    if(PduR_u8eState == PDUR_ONLINE)
    {
        #if(PduR_u8NUMBER_OF_PB_CONFIGS > 0UL)
        strTxTablesRef.pkstrNrmRTxTRf       = PduR_pkstrePbCfg->pkstrLinIfTxRTable;
        strTxTablesRef.pkstrNrmTxFnTblRf    = PduR_pkstrePbCfg->pkstrIf2UpTxFuncTable;
        strTxTablesRef.u16NrmTxTSize        = PduR_pkstrePbCfg->u16LinIfTxRTSize;
        #else
...
/******************************************************************************/
/*! \Description    PduR_LinIfTriggerTransmit \n
    \return         void \n
    \Trace_To       PduR-CDD-0197(0), PduR-CDD-0198(0), PduR-CDD-0201(0)
*******************************************************************************/
    ...
    P2VAR(PduInfoType, AUTOMATIC, PDUR_APPL_DATA)   PduInfoPtr)
{
    ...
    strTxTablesRef.u16MinTxTSize            = PduR_ku16eLinIfTxMinRTSize;
    strTxTablesRef.u8APIId                  = PduR_u8LINIFTRIGGERTRANSMIT;
    ...
    u8Return = PduR_u8LoIfTriggerTransmit(TxPduId, PduInfoPtr, &strTxTablesRef);
