...
/*                                                                            */
/* !File            : intrp1d_iu16n15ff_u32f_la_n.c                           */
/*                                                                            */
...
Float32 intrp1d_iu16n15ff_u32f_la_n(UInt32 localbpIndex, Float32 localfrac,
  const UInt16 localtable[], UInt32 localmaxIndex)
{
  ...
  if (localbpIndex == localmaxIndex) {
    localy = (((Float32)localtable[localbpIndex]) * 3.921508687E-005F) +
      6.000000238E-001F;
  } else {
    localyL_0d0 = localtable[localbpIndex];
    localy = ((((((Float32)localtable[localbpIndex + 1U]) * 3.921508687E-005F)
