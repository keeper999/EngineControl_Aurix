...
/*                                                                            */
/* !Module          : mul_s32_s32_u32_sr6_sat_near                            */
/*                                                                            */
/* !File            : mul_s32_s32_u32_sr6_sat_near.c                          */
/*                                                                            */
...
/*   Code generated on: Fri Jan 15 16:05:43 2010                              */
/******************************************************************************/
/* PVCS Information                                                           */
...
SInt32 mul_s32_s32_u32_sr6_sat_near(SInt32 locala, UInt32 localb)
{
  SInt32 localresult;
  UInt32 localu32_chi;
  UInt32 localu32_clo;
  ...
  localu32_roundup = (UInt32)((localu32_clo & 32U) != 0);
  ...
  localu32_chi = ((UInt32)((localu32_roundup) && (localu32_clo == ((UInt32)0))))
    + ((UInt32)((localtmp >= 0) ? ((SInt32)(((UInt32)localtmp) >> 6)) :
                  (~((SInt32)(((UInt32)(~localtmp)) >> 6)))));
