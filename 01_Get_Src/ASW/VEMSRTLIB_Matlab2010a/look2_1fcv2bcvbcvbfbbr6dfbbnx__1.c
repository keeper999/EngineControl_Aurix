...
/*                                                                            */
/* !Module          : look2_1fcv2bcvbcvbfbbr6dfbbnx__1                           */
/*                                                                            */
/* !File            : look2_1fcv2bcvbcvbfbbr6dfbbnx__1.c                         */
/*                                                                            */
...
/*   Code generated on: Mon Jun 03 13:29:38 2013                              */
/******************************************************************************/
/* PVCS Information                                                           */
...
Float32 look2_1fcv2bcvbcvbfbbr6dfbbnx__1(UInt16 localu0, UInt16 localu1, const
  ...
  const UInt32 localmaxIndex[], UInt32 localstride)
{
  ...
  /* Lookup 2-D
     Canonical function name: look2_iu16u16lftu16n16If_binlcns
  ...
  localfrac = ((((((Float32)localtable[localmaxIndex0 + 1U]) *
                  1.525878906E-005F) + 1.525878906E-005F) - ((((Float32)
    localbpLeftVar) * 1.525878906E-005F) + 1.525878906E-005F)) * localfractions
               [0]) + ((((Float32)localbpLeftVar) * 1.525878906E-005F) +
                       1.525878906E-005F);
  localmaxIndex0 = localmaxIndex0 + localstride;
  localbpLeftVar = localtable[localmaxIndex0];
  localy = (((((((((Float32)localtable[localmaxIndex0 + 1U]) *
                  1.525878906E-005F) + 1.525878906E-005F) - ((((Float32)
    localbpLeftVar) * 1.525878906E-005F) + 1.525878906E-005F)) * localfractions
               [0]) + ((((Float32)localbpLeftVar) * 1.525878906E-005F) +
                       1.525878906E-005F)) - localfrac) * localfractions[1]) +
    localfrac;
  return localy;
}
