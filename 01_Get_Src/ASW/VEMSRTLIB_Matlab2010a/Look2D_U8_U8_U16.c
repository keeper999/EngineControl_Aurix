...
/*********************************************************************
 * Lookup 2D Lookup Utility Look2D_U8_U8_U16
 */
void Look2D_U8_U8_U16( UInt8 *pY, const UInt8 *pYData, UInt8 u0, const
                      UInt8 *pU0Data, UInt32 iHiU0, UInt16 u1, const
