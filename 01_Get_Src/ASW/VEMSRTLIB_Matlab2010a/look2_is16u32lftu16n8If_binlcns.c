...
/*                                                                            */
/* !Module          : look2_is16u32lftu16n8If_binlcns                         */
/*                                                                            */
/* !File            : look2_is16u32lftu16n8If_binlcns.c                       */
/*                                                                            */
...
/*   Code generated on: Tue Feb 05 15:12:13 2013                              */
/******************************************************************************/
/* PVCS Information                                                           */
/* $Archive::   P:/ACT_EMS/LOG/REF/SWC_VEMS/VEMSRTLIB/Matlab2010a/look2_is16u$*/
/* $Revision::   1.0                                                         $*/
/* $Author::   adelvare                               $$Date::   22 Feb 2013 $*/
/******************************************************************************/
/* !CompReq : FLOAT                                                           */
/******************************************************************************/
#include "rtwtypes.h"
...
Float32 look2_is16u32lftu16n8If_binlcns(SInt16 localu0, UInt32 localu1,
  const SInt16 localbp0[], const UInt32 localbp1[], const UInt16
  localtable[], const UInt32 localmaxIndex[], UInt32 localstride)
{
  ...
  localfrac = (((((Float32)localtable[localmaxIndex0 + 1U]) * 0.00390625F) -
                (((Float32)localyL_0d0) * 0.00390625F)) * localfractions[0]) +
    (((Float32)localyL_0d0) * 0.00390625F);
  localmaxIndex0 = localmaxIndex0 + localstride;
  localyL_0d0 = localtable[localmaxIndex0];
  localy = ((((((((Float32)localtable[localmaxIndex0 + 1U]) * 0.00390625F) -
                (((Float32)localyL_0d0) * 0.00390625F)) * localfractions[0]) +
              (((Float32)localyL_0d0) * 0.00390625F)) - localfrac) *
