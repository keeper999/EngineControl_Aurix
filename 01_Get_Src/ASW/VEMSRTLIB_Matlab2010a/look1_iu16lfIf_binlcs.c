...
/*                                                                            */
/* !Module          : look1_iu16lfIf_binlcs                                   */
/*                                                                            */
/* !File            : look1_iu16lfIf_binlcs.c                                 */
/*                                                                            */
...
/*   Code generated on: Tue Jul 17 18:01:49 2012                              */
/******************************************************************************/
/* PVCS Information                                                           */
/* $Archive::   P:/ACT_EMS/LOG/REF/SWC_VEMS/VEMSRTLIB/Matlab2010a/look1_iu16l$*/
/* $Revision::   1.0                                                         $*/
/* $Author::   adelvare                               $$Date::   18 Jul 2012 $*/
/******************************************************************************/
/* !CompReq : FLOAT                                                           */
/******************************************************************************/
#include "rtwtypes.h"
...
Float32 look1_iu16lfIf_binlcs(UInt16 localu0, const UInt16 localbp0[],
  const UInt16 localtable[], UInt32 localmaxIndex)
{
  ...
  localy = (((((Float32)localtable[localiLeft + 1U]) * 781.25F) - (((Float32)
    localbpLeftVar) * 781.25F)) * localfrac) + (((Float32)localbpLeftVar) *
    781.25F);
  return localy;
}
