...
/*                                                                            */
/* !Module          : intrp2d_iu16n7ff_u32f_l_ns                              */
/*                                                                            */
/* !File            : intrp2d_iu16n7ff_u32f_l_ns.c                            */
/*                                                                            */
...
Float32 intrp2d_iu16n7ff_u32f_l_ns(const UInt32 localbpIndex[], const
  Float32 localfrac[], const UInt16 localtable[], UInt32 localstride)
{
  ...
  localy = ((((((((Float32)localtable[localoffset_1d + 1U]) * 0.0078125F) -
                (((Float32)localyL_0d0) * 0.0078125F)) * localfrac[0]) +
              (((Float32)localyL_0d0) * 0.0078125F)) - localyL_1d) * localfrac
            [1]) + localyL_1d;
  return localy;
}
