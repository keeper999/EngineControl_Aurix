...
/*                                                                            */
/* !Module          : Look2D_U8_S16_U16_CEILING                               */
/*                                                                            */
/* !File            : Look2D_U8_S16_U16_CEILING.c                             */
/*                                                                            */
...
/******************************************************************************/
/* PVCS Information                                                           */
/* $Archive::   P:/ACT_EMS/LOG/REF/SWC_VEMS/VEMSRTLIB/Matlab2010a/Look2D_U8_S$*/
/* $Revision::   1.0                                                         $*/
...
/*********************************************************************
 * Lookup 2D Lookup Utility Look2D_U8_S16_U16_CEILING
 */
void Look2D_U8_S16_U16_CEILING( UInt8 *pY, const UInt8 *pYData, SInt16 u0,
  const SInt16 *pU0Data, UInt32 iHiU0, UInt16 u1, const UInt16 *pU1Data,
  UInt32 iHiU1)
{
...

  {
     ...
     */
    INTERPOLATE_U8_U16_CEILING( pY, yLeftLeft, yLeftRght, u1, u1Left, u1Rght);

    /* Interpolate along U1 variable
     *    with the u0 variable locked on the right u0
     */
    INTERPOLATE_U8_U16_CEILING( (&(yTemp)), yRghtLeft, yRghtRght, u1, u1Left,
      u1Rght);
     ...
     */
    INTERPOLATE_U8_S16_CEILING( pY, (*pY), yTemp, u0, u0Left, u0Rght);
  }
}

/* end function Look2D_U8_S16_U16_CEILING
 *********************************************************************/
