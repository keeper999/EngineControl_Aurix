...
/*                                                                            */
/* !Module          : look2_1fw26bc2bcvbfbbr6dfbbnx                           */
/*                                                                            */
/* !File            : look2_1fw26bc2bcvbfbbr6dfbbnx.c                         */
/*                                                                            */
...
/******************************************************************************/
/* PVCS Information                                                           */
/* $Archive::   P:/ACT_EMS/LOG/REF/SWC_VEMS/VEMSRTLIB/Matlab2010a/look2_1fw26$*/
/* $Revision::   1.0                                                         $*/
...
Float32 look2_1fw26bc2bcvbfbbr6dfbbnx(SInt16 localu0, SInt16 localu1, const
  SInt16 localbp0[], const SInt16 localbp1[], const UInt16 localtable[],
  const UInt32 localmaxIndex[], UInt32 localstride)
{
  ...
  /* Lookup 2-D
     Canonical function name: look2_is16s16lftu16n16If_binlcns
  ...
  if (localu1 <= localbp1[0U]) {
    ...
    localfrac = ((Float32)((UInt16)(((UInt32)localu1) - ((UInt32)
      localbpLeftVar)))) / ((Float32)((UInt16)(localbp1[localiLeft + 1U] -
      localbpLeftVar)));
  } else {
  ...
  localfrac = (((((Float32)localtable[localmaxIndex0 + 1U]) * 1.525878906E-005F)
                - (((Float32)localyL_0d0) * 1.525878906E-005F)) *
               localfractions[0]) + (((Float32)localyL_0d0) * 1.525878906E-005F);
  localmaxIndex0 = localmaxIndex0 + localstride;
  localyL_0d0 = localtable[localmaxIndex0];
  localy = ((((((((Float32)localtable[localmaxIndex0 + 1U]) * 1.525878906E-005F)
                - (((Float32)localyL_0d0) * 1.525878906E-005F)) *
               localfractions[0]) + (((Float32)localyL_0d0) * 1.525878906E-005F))
             - localfrac) * localfractions[1]) + localfrac;
  return localy;
}
