...
/*                                                                            */
/* !Module          : look1_iu16lftu8n3If_binlcns                             */
/*                                                                            */
/* !File            : look1_iu16lftu8n3If_binlcns.c                           */
/*                                                                            */
...
Float32 look1_iu16lftu8n3If_binlcns(UInt16 localu0, const UInt16 localbp0[],
  const UInt8 localtable[], UInt32 localmaxIndex)
{
  ...
  localy = (((((Float32)localtable[localiLeft + 1U]) * 2.000000030E-001F) -
             (((Float32)localyL_0d0) * 2.000000030E-001F)) * localfrac) +
    (((Float32)localyL_0d0) * 2.000000030E-001F);
  return localy;
}
