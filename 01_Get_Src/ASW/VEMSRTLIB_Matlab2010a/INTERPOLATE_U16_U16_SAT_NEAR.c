...
/*                                                                            */
/* !Module          : INTERPOLATE_U16_U16_SAT_NEAR                            */
/*                                                                            */
/* !File            : INTERPOLATE_U16_U16_SAT_NEAR.c                          */
/*                                                                            */
...
/*********************************************************************
 * Lookup Interpolation INTERPOLATE_U16_U16_SAT_NEAR
 */
void INTERPOLATE_U16_U16_SAT_NEAR( UInt16 *pY, UInt16 yL, UInt16 yR,
  ...
  *pY = yL;
  ...
  if ((xR > xL) && (x > xL) ) {
...

    {
      ...
      UInt16 rtb_u16_tmp;
      rtb_u32_q = xDen;
      rtb_u32_qY = rtb_u32_q - ((UInt32)xL);
...
/* end INTERPOLATE_U16_U16_SAT_NEAR
 *********************************************************************/
