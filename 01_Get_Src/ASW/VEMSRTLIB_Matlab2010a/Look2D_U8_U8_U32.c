...
/*                                                                            */
/* !Module          : Look2D_U8_U8_U32                                        */
/*                                                                            */
/* !File            : Look2D_U8_U8_U32.c                                      */
/*                                                                            */
...
/*********************************************************************
 * Lookup 2D Lookup Utility Look2D_U8_U8_U32
 */
void Look2D_U8_U8_U32( UInt8 *pY, const UInt8 *pYData, UInt8 u0, const
                      UInt8 *pU0Data, UInt32 iHiU0, UInt32 u1, const
                      UInt32 *pU1Data, UInt32 iHiU1)
{
  ...
  {
    UInt8 u0Left = pU0Data[iLeftU0];
    UInt8 u0Rght = pU0Data[iRghtU0];
