...
/*                                                                            */
/* !Module          : look2_is16u16lfts16p3If_binlcs                          */
/*                                                                            */
/* !File            : look2_is16u16lfts16p3If_binlcs.c                        */
/*                                                                            */
...
/*   Code generated on: Wed Nov 14 16:18:00 2012                              */
/******************************************************************************/
/* PVCS Information                                                           */
/* $Archive::   P:/ACT_EMS/LOG/REF/SWC_VEMS/VEMSRTLIB/Matlab2010a/look2_is16u$*/
/* $Revision::   1.0                                                         $*/
/* $Author::   adelvare                               $$Date::   16 Nov 2012 $*/
/******************************************************************************/
/* !CompReq : FLOAT                                                           */
/******************************************************************************/
#include "rtwtypes.h"
...
Float32 look2_is16u16lfts16p3If_binlcs(SInt16 localu0, UInt16 localu1, const
  ...
  const UInt32 localmaxIndex[], UInt32 localstride)
{
  ...
  localfrac = (((((Float32)localtable[localmaxIndex0 + 1U]) * 8.0F) -
                (((Float32)localbpLeftVar) * 8.0F)) * localfractions[0]) +
    (((Float32)localbpLeftVar) * 8.0F);
  localmaxIndex0 = localmaxIndex0 + localstride;
  localbpLeftVar = localtable[localmaxIndex0];
  localy = ((((((((Float32)localtable[localmaxIndex0 + 1U]) * 8.0F) -
                (((Float32)localbpLeftVar) * 8.0F)) * localfractions[0]) +
              (((Float32)localbpLeftVar) * 8.0F)) - localfrac) *
