...
/*                                                                            */
/* !Module          : look1_iu16lftu16n13If_binlcns__1                           */
/*                                                                            */
/* !File            : look1_iu16lftu16n13If_binlcns__1.c                         */
/*                                                                            */
...
Float32 look1_iu16lftu16n13If_binlcns__1(UInt16 localu0, const UInt16
  localbp0[], const UInt16 localtable[], UInt32 localmaxIndex)
{
  ...
  localy = (((((Float32)localtable[localiLeft + 1U]) * 1.525878906E-004F) -
             (((Float32)localbpLeftVar) * 1.525878906E-004F)) * localfrac) +
    (((Float32)localbpLeftVar) * 1.525878906E-004F);
  return localy;
}
