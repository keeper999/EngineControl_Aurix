...
Float32 intrp1d_iu16n15ff_s32f_la_n__1(SInt32 localbpIndex, Float32 localfrac,
  const UInt16 localtable[], UInt32 localmaxIndex)
{
  ...
  if (((UInt32)localbpIndex) == localmaxIndex) {
    localy = ((Float32)localtable[localoffset_0d]) * 4.577636719E-005F;
  } else {
    localyL_0d0 = localtable[localoffset_0d];
    localy = (((((Float32)localtable[localoffset_0d + 1U]) * 4.577636719E-005F)
               - (((Float32)localyL_0d0) * 4.577636719E-005F)) * localfrac) +
      (((Float32)localyL_0d0) * 4.577636719E-005F);
  }
