...
/*                                                                            */
/* !File            : look1_is16lfts32n9If_binlcns.c                          */
/*                                                                            */
...
Float32 look1_is16lfts32n9If_binlcns(SInt16 localu0, const SInt16 localbp0[],
  const SInt32 localtable[], UInt32 localmaxIndex)
{
  Float32 localy;
  Float32 localfrac;
  ...
  localy = (((((Float32)localtable[localiLeft + 1U]) * 0.001953125F) -
