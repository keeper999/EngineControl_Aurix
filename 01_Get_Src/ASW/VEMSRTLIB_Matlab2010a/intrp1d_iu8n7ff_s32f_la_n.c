...
/*                                                                            */
/* !Module          : intrp1d_iu8n7ff_s32f_la_n                               */
/*                                                                            */
/* !File            : intrp1d_iu8n7ff_s32f_la_n.c                             */
/*                                                                            */
...
Float32 intrp1d_iu8n7ff_s32f_la_n(SInt32 localbpIndex, Float32 localfrac,
  const UInt8 localtable[], UInt32 localmaxIndex)
{
  ...
  if (((UInt32)localbpIndex) == localmaxIndex) {
    localy = ((Float32)localtable[localoffset_0d]) * 0.0078125F;
  } else {
    localyL_0d0 = localtable[localoffset_0d];
    localy = (((((Float32)localtable[localoffset_0d + 1U]) * 0.0078125F) -
               (((Float32)localyL_0d0) * 0.0078125F)) * localfrac) +
