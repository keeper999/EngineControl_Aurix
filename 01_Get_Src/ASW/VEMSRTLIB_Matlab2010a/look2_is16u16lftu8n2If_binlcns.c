...
/*                                                                            */
/* !Module          : look2_is16u16lftu8n2If_binlcns                          */
/*                                                                            */
/* !File            : look2_is16u16lftu8n2If_binlcns.c                        */
/*                                                                            */
...
Float32 look2_is16u16lftu8n2If_binlcns(SInt16 localu0, UInt16 localu1, const
  SInt16 localbp0[], const UInt16 localbp1[], const UInt8 localtable[],
  const UInt32 localmaxIndex[], UInt32 localstride)
{
  ...
  localfrac = ((((((Float32)localtable[localmaxIndex0 + 1U]) * 0.375F) - 36.0F)
                - ((((Float32)localyL_0d0) * 0.375F) - 36.0F)) *
               localfractions[0]) + ((((Float32)localyL_0d0) * 0.375F) - 36.0F);
  localmaxIndex0 = localmaxIndex0 + localstride;
  localyL_0d0 = localtable[localmaxIndex0];
  localy = (((((((((Float32)localtable[localmaxIndex0 + 1U]) * 0.375F) - 36.0F)
                - ((((Float32)localyL_0d0) * 0.375F) - 36.0F)) *
               localfractions[0]) + ((((Float32)localyL_0d0) * 0.375F) - 36.0F))
