...
/*                                                                            */
/* !File            : look2_iu16u16lftu16n7If_binlcns.c                       */
/*                                                                            */
...
Float32 look2_iu16u16lftu16n7If_binlcns(UInt16 localu0, UInt16 localu1,
  ...
  localtable[], const UInt32 localmaxIndex[], UInt32 localstride)
{
  ...
  localfrac = (((((Float32)localtable[localmaxIndex0 + 1U]) * 0.0078125F) -
                (((Float32)localbpLeftVar) * 0.0078125F)) * localfractions[0])
