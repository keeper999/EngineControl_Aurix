...
/*                                                                            */
/* !Module          : look1_iu16lftu16n4If_binlcns__1                            */
/*                                                                            */
/* !File            : look1_iu16lftu16n4If_binlcns__1.c                          */
/*                                                                            */
...
/*   Code generated on: Wed Feb 19 12:06:01 2014                              */
/******************************************************************************/
/* PVCS Information                                                           */
/* $Archive::   P:/ACT_EMS/LOG/REF/SWC_VEMS/VEMSRTLIB/Matlab2010a/look1_iu16l$*/
/* $Revision::   1.0                                                         $*/
/* $Author::   adelvare                               $$Date::   19 Feb 2014 $*/
/******************************************************************************/
/* !CompReq : FLOAT                                                           */
/******************************************************************************/
#include "rtwtypes.h"
...
Float32 look1_iu16lftu16n4If_binlcns__1(UInt16 localu0, const UInt16 localbp0[],
  const UInt16 localtable[], UInt32 localmaxIndex)
{
  ...
  localy = ((((((Float32)localtable[localiLeft + 1U]) * 0.0625F) - 2000.0F) -
             ((((Float32)localbpLeftVar) * 0.0625F) - 2000.0F)) * localfrac) +
    ((((Float32)localbpLeftVar) * 0.0625F) - 2000.0F);
  return localy;
}
