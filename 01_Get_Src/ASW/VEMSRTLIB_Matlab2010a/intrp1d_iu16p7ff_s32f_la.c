...
/*                                                                            */
/* !Module          : intrp1d_iu16p7ff_s32f_la                                */
/*                                                                            */
/* !File            : intrp1d_iu16p7ff_s32f_la.c                              */
/*                                                                            */
...
Float32 intrp1d_iu16p7ff_s32f_la(SInt32 localbpIndex, Float32 localfrac,
  const UInt16 localtable[], UInt32 localmaxIndex)
{
  ...
  if (((UInt32)localbpIndex) == localmaxIndex) {
    localy = ((Float32)localtable[localoffset_0d]) * 128.0F;
  } else {
    localyL_0d0 = localtable[localoffset_0d];
    localy = (((((Float32)localtable[localoffset_0d + 1U]) * 128.0F) -
               (((Float32)localyL_0d0) * 128.0F)) * localfrac) + (((Float32)
      localyL_0d0) * 128.0F);
  }
