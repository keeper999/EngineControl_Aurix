...
/*                                                                            */
/* !Module          : div_repeat_ssu32_sat_floor                              */
/*                                                                            */
/* !File            : div_repeat_ssu32_sat_floor.c                            */
/*                                                                            */
...
/*   Code generated on: Mon Feb 14 14:26:00 2011                              */
/******************************************************************************/
/* PVCS Information                                                           */
...
SInt32 div_repeat_ssu32_sat_floor(SInt32 localnumerator, UInt32
  ...
  if (localdenominator == ((UInt32)0)) {
    ...
    if (localquotientNeedsNegation) {
      localabsNumerator = div_repeat_u32_sat_ceiling(localabsNumerator,
        localdenominator, localnRepeatSub);
      localquotient = (localabsNumerator <= 2147483647U) ? ((SInt32)(-((SInt32)
        localabsNumerator))) : MIN_int32_T;
    } else {
      localabsNumerator = div_repeat_u32_sat(localabsNumerator, localdenominator,
        localnRepeatSub);
