...
/*                                                                            */
/* !Module          : look2_iu8u16lftu16n8If_binlcns                          */
/*                                                                            */
/* !File            : look2_iu8u16lftu16n8If_binlcns.c                        */
/*                                                                            */
...
/*   Code generated on: Thu Sep 06 20:11:04 2012                              */
/******************************************************************************/
/* PVCS Information                                                           */
/* $Archive::   P:/ACT_EMS/LOG/REF/SWC_VEMS/VEMSRTLIB/Matlab2010a/look2_iu8u1$*/
/* $Revision::   1.0                                                         $*/
/* $Author::   adelvare                               $$Date::   27 Sep 2012 $*/
/******************************************************************************/
/* !CompReq : FLOAT                                                           */
/******************************************************************************/
#include "rtwtypes.h"
...
Float32 look2_iu8u16lftu16n8If_binlcns(UInt8 localu0, UInt16 localu1, const
  UInt8 localbp0[], const UInt16 localbp1[], const UInt16 localtable[],
  const UInt32 localmaxIndex[], UInt32 localstride)
{
  ...
  if (localu1 <= localbp1[0U]) {
    ...
    localfrac = ((Float32)((UInt16)(((UInt32)localu1) - ((UInt32)
      localbpLeftVar_0)))) / ((Float32)((UInt16)(((UInt32)
      localbp1[localiLeft + 1U]) - ((UInt32)localbpLeftVar_0))));
  } else {
  ...
  localbpLeftVar_0 = localtable[localmaxIndex0];
  localfrac = (((((Float32)localtable[localmaxIndex0 + 1U]) * 0.00390625F) -
                (((Float32)localbpLeftVar_0) * 0.00390625F)) * localfractions[0])
    + (((Float32)localbpLeftVar_0) * 0.00390625F);
  localmaxIndex0 = localmaxIndex0 + localstride;
  localbpLeftVar_0 = localtable[localmaxIndex0];
  localy = ((((((((Float32)localtable[localmaxIndex0 + 1U]) * 0.00390625F) -
                (((Float32)localbpLeftVar_0) * 0.00390625F)) * localfractions[0])
              + (((Float32)localbpLeftVar_0) * 0.00390625F)) - localfrac) *
