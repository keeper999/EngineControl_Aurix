...
/*                                                                            */
/* !Module          : look2_1fcv2bcvbcvbfbba5nfbbnx                           */
/*                                                                            */
/* !File            : look2_1fcv2bcvbcvbfbba5nfbbnx.c                         */
/*                                                                            */
...
Float32 look2_1fcv2bcvbcvbfbba5nfbbnx(UInt16 localu0, UInt16 localu1, const
  ...
  const UInt32 localmaxIndex[], UInt32 localstride)
{
  ...
  /* Lookup 2-D
     Canonical function name: look2_iu16u16lftu32n19If_binlcns
  ...
  localfrac = (((((Float32)localtable[localbpIdx + 1U]) * 3.200000037E-006F) -
                (((Float32)localmaxIndex0) * 3.200000037E-006F)) *
               localfractions[0]) + (((Float32)localmaxIndex0) *
    3.200000037E-006F);
  localbpIdx = localbpIdx + localstride;
  localmaxIndex0 = localtable[localbpIdx];
  localy = ((((((((Float32)localtable[localbpIdx + 1U]) * 3.200000037E-006F) -
                (((Float32)localmaxIndex0) * 3.200000037E-006F)) *
               localfractions[0]) + (((Float32)localmaxIndex0) *
