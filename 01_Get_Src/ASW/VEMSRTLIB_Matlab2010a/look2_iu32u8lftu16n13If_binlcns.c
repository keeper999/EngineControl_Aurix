...
/*                                                                            */
/* !Module          : look2_iu32u8lftu16n13If_binlcns                         */
/*                                                                            */
/* !File            : look2_iu32u8lftu16n13If_binlcns.c                       */
/*                                                                            */
...
/******************************************************************************/
/* PVCS Information                                                           */
/* $Archive::   P:/ACT_EMS/LOG/REF/SWC_VEMS/VEMSRTLIB/Matlab2010a/look2_iu32u$*/
/* $Revision::   1.1                                                         $*/
...
Float32 look2_iu32u8lftu16n13If_binlcns(UInt32 localu0, UInt8 localu1,
  const UInt32 localbp0[], const UInt8 localbp1[], const UInt16
  localtable[], const UInt32 localmaxIndex[], UInt32 localstride)
{
  ...
  if (localu0 <= localbp0[0U]) {
    ...
    localmaxIndex0 = localbp0[localiLeft];
    localfrac = (Float32)(((Float32d)(localu0 - localmaxIndex0)) / ((Float32d)
      (localbp0[localiLeft + 1U] - localmaxIndex0)));
  } else {
