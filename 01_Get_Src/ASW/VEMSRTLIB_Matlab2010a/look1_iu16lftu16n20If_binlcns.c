...
/*                                                                            */
/* !Module          : look1_iu16lftu16n20If_binlcns                           */
/*                                                                            */
/* !File            : look1_iu16lftu16n20If_binlcns.c                         */
/*                                                                            */
...
Float32 look1_iu16lftu16n20If_binlcns(UInt16 localu0, const UInt16
  localbp0[], const UInt16 localtable[], UInt32 localmaxIndex)
{
  ...
  localy = ((((((Float32)localtable[localiLeft + 1U]) * 9.536743164E-007F) +
              9.536743164E-007F) - ((((Float32)localbpLeftVar) *
    9.536743164E-007F) + 9.536743164E-007F)) * localfrac) + ((((Float32)
    localbpLeftVar) * 9.536743164E-007F) + 9.536743164E-007F);
  return localy;
}
