...
/*                                                                            */
/* !Module          : mul_s32_s32_u32_sr12_sat_near                           */
/*                                                                            */
/* !File            : mul_s32_s32_u32_sr12_sat_near.c                         */
/*                                                                            */
...
SInt32 mul_s32_s32_u32_sr12_sat_near(SInt32 locala, UInt32 localb)
{
  SInt32 localresult;
  UInt32 localu32_chi;
  UInt32 localu32_clo;
  ...
  localu32_roundup = (UInt32)((localu32_clo & 2048U) != 0);
  localu32_clo = ((UInt32)((localu32_chi << 20) | (localu32_clo >> 12))) +
    localu32_roundup;
  localtmp = (SInt32)localu32_chi;
  localu32_chi = ((UInt32)((localu32_roundup) && (localu32_clo == ((UInt32)0))))
    + ((UInt32)((localtmp >= 0) ? ((SInt32)(((UInt32)localtmp) >> 12)) :
                  (~((SInt32)(((UInt32)(~localtmp)) >> 12)))));
