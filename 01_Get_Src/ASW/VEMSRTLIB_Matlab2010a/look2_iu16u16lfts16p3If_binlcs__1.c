...
/*                                                                            */
/* !Module          : look2_iu16u16lfts16p3If_binlcs__1                          */
/*                                                                            */
/* !File            : look2_iu16u16lfts16p3If_binlcs__1.c                        */
/*                                                                            */
...
Float32 look2_iu16u16lfts16p3If_binlcs__1(UInt16 localu0, UInt16 localu1,
  ...
  localtable[], const UInt32 localmaxIndex[], UInt32 localstride)
{
  ...
  localfrac = ((((((Float32)localtable[localmaxIndex0 + 1U]) * 8.0F) + 4.0F) -
                ((((Float32)localyL_0d0) * 8.0F) + 4.0F)) * localfractions[0])
    + ((((Float32)localyL_0d0) * 8.0F) + 4.0F);
  localmaxIndex0 = localmaxIndex0 + localstride;
  localyL_0d0 = localtable[localmaxIndex0];
  localy = (((((((((Float32)localtable[localmaxIndex0 + 1U]) * 8.0F) + 4.0F) -
                ((((Float32)localyL_0d0) * 8.0F) + 4.0F)) * localfractions[0])
              + ((((Float32)localyL_0d0) * 8.0F) + 4.0F)) - localfrac) *
