...
/*                                                                            */
/* !Module          : look2_iu16u16lftu16n5If_binlcns                         */
/*                                                                            */
/* !File            : look2_iu16u16lftu16n5If_binlcns.c                       */
/*                                                                            */
...
Float32 look2_iu16u16lftu16n5If_binlcns(UInt16 localu0, UInt16 localu1,
  ...
  localtable[], const UInt32 localmaxIndex[], UInt32 localstride)
{
  ...
  localfrac = (((((Float32)localtable[localmaxIndex0 + 1U]) * 5.000000075E-002F)
                - (((Float32)localbpLeftVar) * 5.000000075E-002F)) *
               localfractions[0]) + (((Float32)localbpLeftVar) *
    5.000000075E-002F);
  localmaxIndex0 = localmaxIndex0 + localstride;
  localbpLeftVar = localtable[localmaxIndex0];
  localy = ((((((((Float32)localtable[localmaxIndex0 + 1U]) * 5.000000075E-002F)
                - (((Float32)localbpLeftVar) * 5.000000075E-002F)) *
               localfractions[0]) + (((Float32)localbpLeftVar) *
    5.000000075E-002F)) - localfrac) * localfractions[1]) + localfrac;
  return localy;
}
