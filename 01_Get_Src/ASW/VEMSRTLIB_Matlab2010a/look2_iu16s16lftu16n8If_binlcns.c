...
/*                                                                            */
/* !Module          : look2_iu16s16lftu16n8If_binlcns                         */
/*                                                                            */
/* !File            : look2_iu16s16lftu16n8If_binlcns.c                       */
/*                                                                            */
...
Float32 look2_iu16s16lftu16n8If_binlcns(UInt16 localu0, SInt16 localu1,
  ...
  localtable[], const UInt32 localmaxIndex[], UInt32 localstride)
{
  ...
  localfrac = (((((Float32)localtable[localmaxIndex0 + 1U]) * 0.00390625F) -
                (((Float32)localbpLeftVar) * 0.00390625F)) * localfractions[0])
    + (((Float32)localbpLeftVar) * 0.00390625F);
  localmaxIndex0 = localmaxIndex0 + localstride;
  localbpLeftVar = localtable[localmaxIndex0];
  localy = ((((((((Float32)localtable[localmaxIndex0 + 1U]) * 0.00390625F) -
                (((Float32)localbpLeftVar) * 0.00390625F)) * localfractions[0])
              + (((Float32)localbpLeftVar) * 0.00390625F)) - localfrac) *
