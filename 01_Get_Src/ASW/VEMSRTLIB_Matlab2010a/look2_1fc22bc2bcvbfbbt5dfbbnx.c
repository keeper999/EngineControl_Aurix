...
/*                                                                            */
/* !Module          : look2_1fc22bc2bcvbfbbt5dfbbnx                           */
/*                                                                            */
/* !File            : look2_1fc22bc2bcvbfbbt5dfbbnx.c                         */
/*                                                                            */
...
/*   Code generated on: Tue Jul 10 14:53:30 2012                              */
/******************************************************************************/
/* PVCS Information                                                           */
/* $Archive::   P:/ACT_EMS/LOG/REF/SWC_VEMS/VEMSRTLIB/Matlab2010a/look2_1fc22$*/
/* $Revision::   1.2                                                         $*/
...
Float32 look2_1fc22bc2bcvbfbbt5dfbbnx(UInt16 localu0, SInt16 localu1, const
  UInt16 localbp0[], const SInt16 localbp1[], const SInt16 localtable[],
  const UInt32 localmaxIndex[], UInt32 localstride)
{
  ...
  /* Lookup 2-D
     Canonical function name: look2_iu16s16lfts16n20If_binlcns
  ...
  localfrac = (((((Float32)localtable[localmaxIndex0 + 1U]) * 1.525878929E-006F)
                - (((Float32)localbpLeftVar_0) * 1.525878929E-006F)) *
               localfractions[0]) + (((Float32)localbpLeftVar_0) *
    1.525878929E-006F);
  localmaxIndex0 = localmaxIndex0 + localstride;
  localbpLeftVar_0 = localtable[localmaxIndex0];
  localy = ((((((((Float32)localtable[localmaxIndex0 + 1U]) * 1.525878929E-006F)
                - (((Float32)localbpLeftVar_0) * 1.525878929E-006F)) *
               localfractions[0]) + (((Float32)localbpLeftVar_0) *
    1.525878929E-006F)) - localfrac) * localfractions[1]) + localfrac;
  return localy;
}
