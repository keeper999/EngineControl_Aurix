...
/*                                                                            */
/* !Module          : intrp2d_is16n17ff_u32f_l_ns                             */
/*                                                                            */
/* !File            : intrp2d_is16n17ff_u32f_l_ns.c                           */
/*                                                                            */
...
Float32 intrp2d_is16n17ff_u32f_l_ns(const UInt32 localbpIndex[], const
  Float32 localfrac[], const SInt16 localtable[], UInt32 localstride)
{
  ...
  localyL_1d = (((((Float32)localtable[localoffset_1d + 1U]) *
                  7.629394531E-006F) - (((Float32)localyL_0d0) *
    7.629394531E-006F)) * localfrac[0]) + (((Float32)localyL_0d0) *
    7.629394531E-006F);
  localoffset_1d = localoffset_1d + localstride;
  localyL_0d0 = localtable[localoffset_1d];
  localy = ((((((((Float32)localtable[localoffset_1d + 1U]) * 7.629394531E-006F)
                - (((Float32)localyL_0d0) * 7.629394531E-006F)) * localfrac[0])
              + (((Float32)localyL_0d0) * 7.629394531E-006F)) - localyL_1d) *
