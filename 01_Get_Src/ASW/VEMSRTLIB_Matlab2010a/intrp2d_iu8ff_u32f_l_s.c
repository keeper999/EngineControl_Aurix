...
Float32 intrp2d_iu8ff_u32f_l_s(const UInt32 localbpIndex[], const Float32
  localfrac[], const UInt8 localtable[], UInt32 localstride)
{
  ...
  localyL_1d = (((((Float32)localtable[localoffset_1d + 1U]) + 233.0F) -
                 (((Float32)localyL_0d0) + 233.0F)) * localfrac[0]) +
    (((Float32)localyL_0d0) + 233.0F);
  localoffset_1d = localoffset_1d + localstride;
  localyL_0d0 = localtable[localoffset_1d];
  localy = ((((((((Float32)localtable[localoffset_1d + 1U]) + 233.0F) -
                (((Float32)localyL_0d0) + 233.0F)) * localfrac[0]) +
              (((Float32)localyL_0d0) + 233.0F)) - localyL_1d) * localfrac[1])
    + localyL_1d;
  return localy;
}
