...
/*                                                                            */
/* !Module          : INTERPOLATE_S8_U8                                       */
/*                                                                            */
/* !File            : INTERPOLATE_S8_U8.c                                     */
/*                                                                            */
...
/*********************************************************************
 * Lookup Interpolation INTERPOLATE_S8_U8
 */
void INTERPOLATE_S8_U8( SInt8 *pY, SInt8 yL, SInt8 yR, UInt8 x, UInt8 xL,
  UInt8 xR)
{
  SInt32 bigProd;
  SInt8 yDiff;
