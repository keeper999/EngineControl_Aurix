...
/*                                                                            */
/* !Module          : look1_iu16lftu32n5If_binlcns                            */
/*                                                                            */
/* !File            : look1_iu16lftu32n5If_binlcns.c                          */
/*                                                                            */
...
Float32 look1_iu16lftu32n5If_binlcns(UInt16 localu0, const UInt16 localbp0[],
  const UInt32 localtable[], UInt32 localmaxIndex)
{
  ...
  localy = (((((Float32)localtable[localiLeft + 1U]) * 0.03125F) - (((Float32)
    localbpIdx) * 0.03125F)) * localfrac) + (((Float32)localbpIdx) * 0.03125F);
  return localy;
}
