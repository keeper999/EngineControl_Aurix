...
/*                                                                            */
/* !Module          : look2_iu8lftu8n5If_binlcns                              */
/*                                                                            */
/* !File            : look2_iu8lftu8n5If_binlcns.c                            */
/*                                                                            */
...
Float32 look2_iu8lftu8n5If_binlcns(UInt8 localu0, UInt8 localu1, const
  UInt8 localbp0[], const UInt8 localbp1[], const UInt8 localtable[],
  const UInt32 localmaxIndex[], UInt32 localstride)
{
  ...
  localfrac = (((((Float32)localtable[localmaxIndex0 + 1U]) * 3.999999911E-002F)
                - (((Float32)localbpLeftVar) * 3.999999911E-002F)) *
               localfractions[0]) + (((Float32)localbpLeftVar) *
    3.999999911E-002F);
  localmaxIndex0 = localmaxIndex0 + localstride;
  localbpLeftVar = localtable[localmaxIndex0];
  localy = ((((((((Float32)localtable[localmaxIndex0 + 1U]) * 3.999999911E-002F)
                - (((Float32)localbpLeftVar) * 3.999999911E-002F)) *
               localfractions[0]) + (((Float32)localbpLeftVar) *
    3.999999911E-002F)) - localfrac) * localfractions[1]) + localfrac;
  return localy;
}
