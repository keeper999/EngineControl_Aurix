...
/*                                                                            */
/* !Module          : intrp2d_iu8n8ff_s32f_la_n                               */
/*                                                                            */
/* !File            : intrp2d_iu8n8ff_s32f_la_n.c                             */
/*                                                                            */
...
Float32 intrp2d_iu8n8ff_s32f_la_n(const SInt32 localbpIndex[], const Float32
  ...
  localmaxIndex[])
{
  ...
  if (((UInt32)localbpIndex[0]) == localmaxIndex[0]) {
    localyL_1d = ((Float32)localtable[localoffset_1d]) * 0.00390625F;
  } else {
    localyL_0d0 = localtable[localoffset_1d];
    localyL_1d = (((((Float32)localtable[localoffset_1d + 1U]) * 0.00390625F) -
                   (((Float32)localyL_0d0) * 0.00390625F)) * localfrac[0]) +
  ...
  if (((UInt32)localbpIndex[1]) == localmaxIndex[1]) {
    ...
    if (((UInt32)localbpIndex[0]) == localmaxIndex[0]) {
      localyR_1d = ((Float32)localtable[localoffset_1d]) * 0.00390625F;
    } else {
      localyL_0d0 = localtable[localoffset_1d];
      localyR_1d = (((((Float32)localtable[localoffset_1d + 1U]) * 0.00390625F)
                     - (((Float32)localyL_0d0) * 0.00390625F)) * localfrac[0])
        + (((Float32)localyL_0d0) * 0.00390625F);
    }
