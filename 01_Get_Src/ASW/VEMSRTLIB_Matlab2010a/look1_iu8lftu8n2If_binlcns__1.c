...
/*                                                                            */
/* !Module          : look1_iu8lftu8n2If_binlcns__1                              */
/*                                                                            */
/* !File            : look1_iu8lftu8n2If_binlcns__1.c                            */
/*                                                                            */
...
/*   Code generated on: Sun Jan 13 16:25:22 2013                              */
/******************************************************************************/
/* PVCS Information                                                           */
/* $Archive::   P:/ACT_EMS/LOG/REF/SWC_VEMS/VEMSRTLIB/Matlab2010a/look1_iu8lf$*/
/* $Revision::   1.0                                                         $*/
/* $Author::   adelvare                               $$Date::   17 Jan 2013 $*/
/******************************************************************************/
/* !CompReq : FLOAT                                                           */
/******************************************************************************/
#include "rtwtypes.h"
...
Float32 look1_iu8lftu8n2If_binlcns__1(UInt8 localu0, const UInt8 localbp0[],
  const UInt8 localtable[], UInt32 localmaxIndex)
{
  ...
  localy = ((((((Float32)localtable[localiLeft + 1U]) * 0.375F) - 36.0F) -
             ((((Float32)localbpLeftVar) * 0.375F) - 36.0F)) * localfrac) +
    ((((Float32)localbpLeftVar) * 0.375F) - 36.0F);
  return localy;
}
