...
/*                                                                            */
/* !Module          : intrp2d_iu16n16ff_s32f_la_ns                            */
/*                                                                            */
/* !File            : intrp2d_iu16n16ff_s32f_la_ns.c                          */
/*                                                                            */
...
Float32 intrp2d_iu16n16ff_s32f_la_ns(const SInt32 localbpIndex[], const
  ...
  UInt32 localmaxIndex[])
{
  ...
  if (((UInt32)localbpIndex[0]) == localmaxIndex[0]) {
    ...
    localyL_1d = (((((Float32)localtable[localoffset_1d + 1U]) *
                    1.525878906E-005F) - (((Float32)localyL_0d0) *
      1.525878906E-005F)) * localfrac[0]) + (((Float32)localyL_0d0) *
      1.525878906E-005F);
  }
