...
/*                                                                            */
/* !Module          : look1_iu16lftu16n16If_binlcns                           */
/*                                                                            */
/* !File            : look1_iu16lftu16n16If_binlcns.c                         */
/*                                                                            */
...
Float32 look1_iu16lftu16n16If_binlcns(UInt16 localu0, const UInt16
  localbp0[], const UInt16 localtable[], UInt32 localmaxIndex)
{
  ...
  localy = (((((Float32)localtable[localiLeft + 1U]) * 1.525878906E-005F) -
             (((Float32)localbpLeftVar) * 1.525878906E-005F)) * localfrac) +
