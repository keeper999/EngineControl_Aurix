...
/*                                                                            */
/* !Module          : look1_iu8lftu16n3If_binlcns                             */
/*                                                                            */
/* !File            : look1_iu8lftu16n3If_binlcns.c                           */
/*                                                                            */
...
Float32 look1_iu8lftu16n3If_binlcns(UInt8 localu0, const UInt8 localbp0[],
  const UInt16 localtable[], UInt32 localmaxIndex)
{
  ...
  localy = (((((Float32)localtable[localiLeft + 1U]) * 0.125F) - (((Float32)
    localyL_0d0) * 0.125F)) * localfrac) + (((Float32)localyL_0d0) * 0.125F);
  return localy;
}
