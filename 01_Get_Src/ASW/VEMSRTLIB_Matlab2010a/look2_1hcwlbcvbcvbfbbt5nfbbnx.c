...
/*                                                                            */
/* !Module          : look2_1hcwlbcvbcvbfbbt5nfbbnx                           */
/*                                                                            */
/* !File            : look2_1hcwlbcvbcvbfbbt5nfbbnx.c                         */
/*                                                                            */
...
/******************************************************************************/
/* PVCS Information                                                           */
/* $Archive::   P:/ACT_EMS/LOG/REF/SWC_VEMS/VEMSRTLIB/Matlab2010a/look2_1hcwl$*/
/* $Revision::   1.1                                                         $*/
...
Float32 look2_1hcwlbcvbcvbfbbt5nfbbnx(UInt32 localu0, UInt16 localu1, const
  UInt32 localbp0[], const UInt16 localbp1[], const SInt16 localtable[],
  const UInt32 localmaxIndex[], UInt32 localstride)
{
  ...
  /* Lookup 2-D
     Canonical function name: look2_iu32u16lfts16n19If_binlcns
  ...
  localfrac = (((((Float32)localtable[localmaxIndex0 + 1U]) * 3.200000037E-006F)
                - (((Float32)localyL_0d0) * 3.200000037E-006F)) *
               localfractions[0]) + (((Float32)localyL_0d0) * 3.200000037E-006F);
