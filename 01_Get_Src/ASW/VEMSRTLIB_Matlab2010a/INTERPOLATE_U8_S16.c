...
/*                                                                            */
/* !Module          : INTERPOLATE_U8_S16                                      */
/*                                                                            */
/* !File            : INTERPOLATE_U8_S16.c                                    */
/*                                                                            */
...
/*********************************************************************
 * Lookup Interpolation INTERPOLATE_U8_S16
 */
void INTERPOLATE_U8_S16( UInt8 *pY, UInt8 yL, UInt8 yR, SInt16 x, SInt16
  xL, SInt16 xR)
{
  SInt32 bigProd;
  UInt8 yDiff;
  ...
  *pY = yL;
  ...
  if ((xR > xL) && (x > xL) ) {
    ...
    bigProd = yDiff * xNum;
    yDiff = (UInt8)div_s32_floor(bigProd, (SInt32)xDen);
    if (yR >= yL ) {
