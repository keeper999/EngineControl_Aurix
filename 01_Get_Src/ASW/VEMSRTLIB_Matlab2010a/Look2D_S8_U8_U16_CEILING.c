...
/*                                                                            */
/* !Module          : Look2D_S8_U8_U16_CEILING                                */
/*                                                                            */
/* !File            : Look2D_S8_U8_U16_CEILING.c                              */
/*                                                                            */
...
/*********************************************************************
 * Lookup 2D Lookup Utility Look2D_S8_U8_U16_CEILING
 */
void Look2D_S8_U8_U16_CEILING( SInt8 *pY, const SInt8 *pYData, UInt8 u0,
  ...
  UInt32 iHiU1)
{
...

  {
     ...
     */
    INTERPOLATE_S8_U16_CEILING( pY, yLeftLeft, yLeftRght, u1, u1Left, u1Rght);

    /* Interpolate along U1 variable
     *    with the u0 variable locked on the right u0
     */
    INTERPOLATE_S8_U16_CEILING( (&(yTemp)), yRghtLeft, yRghtRght, u1, u1Left,
      u1Rght);
     ...
     */
    INTERPOLATE_S8_U8_CEILING( pY, (*pY), yTemp, u0, u0Left, u0Rght);
  }
}

/* end function Look2D_S8_U8_U16_CEILING
 *********************************************************************/
