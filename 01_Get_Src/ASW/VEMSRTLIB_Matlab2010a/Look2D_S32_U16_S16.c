...
/*                                                                            */
/* !Module          : Look2D_S32_U16_S16                                      */
/*                                                                            */
/* !File            : Look2D_S32_U16_S16.c                                    */
/*                                                                            */
...
/*********************************************************************
 * Lookup 2D Lookup Utility Look2D_S32_U16_S16
 */
void Look2D_S32_U16_S16( SInt32 *pY, const SInt32 *pYData, UInt16 u0, const
  ...
  UInt32 iHiU1)
{
...

  {
    ...
    if (u1Rght > u1Left ) {
      ...
      SInt16 den;
      den = u1Rght;
      den = (SInt16)(den - u1Left);
      num = u1;
      num = (SInt16)(num - u1Left);
      u1Lambda = div_repeat_us32_floor(num << 16U, (SInt32)den, (UInt32)15);
    } else {
      u1Lambda = 0U;
    }
...
/* end function Look2D_S32_U16_S16
 *********************************************************************/
