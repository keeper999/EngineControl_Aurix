...
/*                                                                            */
/* !Module          : plook_s32s16f_bincpa                                    */
/*                                                                            */
/* !File            : plook_s32s16f_bincpa.c                                  */
/*                                                                            */
...
SInt32 plook_s32s16f_bincpa(SInt16 localu, const SInt16 localbp[], UInt32
  localmaxIndex, Float32 *localfraction, SInt32 *localprevIndex)
{
  ...
  if (localu <= localbp[0U]) {
    ...
    *localfraction = ((Float32)((UInt16)(((UInt32)localu) - ((UInt32)
      localbpLeftVar)))) / ((Float32)((UInt16)(localbp[((UInt32)
      localbpIndex) + 1U] - localbpLeftVar)));
  } else {
