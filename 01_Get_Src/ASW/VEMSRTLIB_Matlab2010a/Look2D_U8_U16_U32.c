...
/*********************************************************************
 * Lookup 2D Lookup Utility Look2D_U8_U16_U32
 */
...

  {
     ...
     */
    {
      ...
      if (yLeftRght >= yLeftLeft ) {
        absDiff = yLeftRght;
        absDiff = (UInt8)(((UInt32)absDiff) - ((UInt32)yLeftLeft));
        yTemp2 = (UInt8)mul_u32_u32_u32_sr31(u1Lambda, (UInt32)absDiff);
        (*pY) = (UInt8)(((UInt32)(*pY)) + ((UInt32)yTemp2));
      } else {
        absDiff = yLeftLeft;
        absDiff = (UInt8)(((UInt32)absDiff) - ((UInt32)yLeftRght));
        yTemp2 = (UInt8)mul_u32_u32_u32_sr31(u1Lambda, (UInt32)absDiff);
        (*pY) = (UInt8)(((UInt32)(*pY)) - ((UInt32)yTemp2));
      }
    }
     ...
     */
    {
      ...
      if (yRghtRght >= yRghtLeft ) {
        absDiff = yRghtRght;
        absDiff = (UInt8)(((UInt32)absDiff) - ((UInt32)yRghtLeft));
        yTemp2 = (UInt8)mul_u32_u32_u32_sr31(u1Lambda, (UInt32)absDiff);
        yTemp = (UInt8)(((UInt32)yTemp) + ((UInt32)yTemp2));
      } else {
        absDiff = yRghtLeft;
        absDiff = (UInt8)(((UInt32)absDiff) - ((UInt32)yRghtRght));
        yTemp2 = (UInt8)mul_u32_u32_u32_sr31(u1Lambda, (UInt32)absDiff);
        yTemp = (UInt8)(((UInt32)yTemp) - ((UInt32)yTemp2));
      }
    }
     ...
     */
    INTERPOLATE_U8_U16( pY, (*pY), yTemp, u0, u0Left, u0Rght);
  }
}

/* end function Look2D_U8_U16_U32
 *********************************************************************/
