...
/*                                                                            */
/* !File            : plook_s32u32u32n31_bincpa_s.c                           */
/*                                                                            */
...
SInt32 plook_s32u32u32n31_bincpa_s(UInt32 localu, const UInt32 localbp[],
  UInt32 localmaxIndex, UInt32 *localfraction, SInt32 *localprevIndex)
{
  ...
  if (localu <= localbp[0U]) {
    ...
    *localfraction = div_repeat_u32(localu - localstartIndex, localbp[((UInt32)
      localbpIndex) + 1U] - localstartIndex, 31U);
  } else {
