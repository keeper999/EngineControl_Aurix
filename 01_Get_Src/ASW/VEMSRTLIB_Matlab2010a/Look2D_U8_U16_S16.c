...
/*                                                                            */
/* !Module          : Look2D_U8_U16_S16                                       */
/*                                                                            */
/* !File            : Look2D_U8_U16_S16.c                                     */
/*                                                                            */
...
/*********************************************************************
 * Lookup 2D Lookup Utility Look2D_U8_U16_S16
 */
void Look2D_U8_U16_S16( UInt8 *pY, const UInt8 *pYData, UInt16 u0, const
  ...
  UInt32 iHiU1)
{
...

  {
     ...
     */
    INTERPOLATE_U8_S16( pY, yLeftLeft, yLeftRght, u1, u1Left, u1Rght);

    /* Interpolate along U1 variable
     *    with the u0 variable locked on the right u0
     */
    INTERPOLATE_U8_S16( (&(yTemp)), yRghtLeft, yRghtRght, u1, u1Left, u1Rght);
...
/* end function Look2D_U8_U16_S16
 *********************************************************************/
