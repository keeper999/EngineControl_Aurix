...
/*                                                                            */
/* !Module          : look2_is16u16lfts16p3If_binlcs__1                          */
/*                                                                            */
/* !File            : look2_is16u16lfts16p3If_binlcs__1.c                        */
/*                                                                            */
...
/*   Code generated on: Mon Jan 14 16:32:47 2013                              */
/******************************************************************************/
/* PVCS Information                                                           */
/* $Archive::   P:/ACT_EMS/LOG/REF/SWC_VEMS/VEMSRTLIB/Matlab2010a/look2_is16u$*/
/* $Revision::   1.0                                                         $*/
...
Float32 look2_is16u16lfts16p3If_binlcs__1(SInt16 localu0, UInt16 localu1, const
  SInt16 localbp0[], const UInt16 localbp1[], const SInt16 localtable[],
  const UInt32 localmaxIndex[], UInt32 localstride)
{
  ...
  localfrac = ((((((Float32)localtable[localmaxIndex0 + 1U]) * 8.0F) + 4.0F) -
                ((((Float32)localbpLeftVar) * 8.0F) + 4.0F)) * localfractions[0])
    + ((((Float32)localbpLeftVar) * 8.0F) + 4.0F);
  localmaxIndex0 = localmaxIndex0 + localstride;
  localbpLeftVar = localtable[localmaxIndex0];
  localy = (((((((((Float32)localtable[localmaxIndex0 + 1U]) * 8.0F) + 4.0F) -
                ((((Float32)localbpLeftVar) * 8.0F) + 4.0F)) * localfractions[0])
              + ((((Float32)localbpLeftVar) * 8.0F) + 4.0F)) - localfrac) *
