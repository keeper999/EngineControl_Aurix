...
/*                                                                            */
/* !Module          : intrp2d_is16n15ff_u32f_l_ns                             */
/*                                                                            */
/* !File            : intrp2d_is16n15ff_u32f_l_ns.c                           */
/*                                                                            */
...
Float32 intrp2d_is16n15ff_u32f_l_ns(const UInt32 localbpIndex[], const
  Float32 localfrac[], const SInt16 localtable[], UInt32 localstride)
{
  ...
  localyL_0d0 = localtable[localoffset_1d];
  localy = ((((((((Float32)localtable[localoffset_1d + 1U]) * 3.051757813E-005F)
                - (((Float32)localyL_0d0) * 3.051757813E-005F)) * localfrac[0])
              + (((Float32)localyL_0d0) * 3.051757813E-005F)) - localyL_1d) *
