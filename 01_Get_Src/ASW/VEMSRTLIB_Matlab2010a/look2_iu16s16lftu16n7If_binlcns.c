...
/*                                                                            */
/* !Module          : look2_iu16s16lftu16n7If_binlcns                         */
/*                                                                            */
/* !File            : look2_iu16s16lftu16n7If_binlcns.c                       */
/*                                                                            */
...
Float32 look2_iu16s16lftu16n7If_binlcns(UInt16 localu0, SInt16 localu1,
  ...
  localtable[], const UInt32 localmaxIndex[], UInt32 localstride)
{
  ...
  localfrac = (((((Float32)localtable[localmaxIndex0 + 1U]) * 9.999999776E-003F)
                - (((Float32)localbpLeftVar) * 9.999999776E-003F)) *
               localfractions[0]) + (((Float32)localbpLeftVar) *
    9.999999776E-003F);
  localmaxIndex0 = localmaxIndex0 + localstride;
  localbpLeftVar = localtable[localmaxIndex0];
  localy = ((((((((Float32)localtable[localmaxIndex0 + 1U]) * 9.999999776E-003F)
                - (((Float32)localbpLeftVar) * 9.999999776E-003F)) *
               localfractions[0]) + (((Float32)localbpLeftVar) *
    9.999999776E-003F)) - localfrac) * localfractions[1]) + localfrac;
  return localy;
}
