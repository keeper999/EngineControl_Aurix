...
Float32 intrp2d_iu16n13ff_u32f_l_ns__1(const UInt32 localbpIndex[], const
  Float32 localfrac[], const UInt16 localtable[], UInt32 localstride)
{
  ...
  localyL_1d = (((((Float32)localtable[localoffset_1d + 1U]) *
                  1.678466797E-004F) - (((Float32)localyL_0d0) *
    1.678466797E-004F)) * localfrac[0]) + (((Float32)localyL_0d0) *
    1.678466797E-004F);
  localoffset_1d = localoffset_1d + localstride;
  localyL_0d0 = localtable[localoffset_1d];
  localy = ((((((((Float32)localtable[localoffset_1d + 1U]) * 1.678466797E-004F)
                - (((Float32)localyL_0d0) * 1.678466797E-004F)) * localfrac[0])
              + (((Float32)localyL_0d0) * 1.678466797E-004F)) - localyL_1d) *
