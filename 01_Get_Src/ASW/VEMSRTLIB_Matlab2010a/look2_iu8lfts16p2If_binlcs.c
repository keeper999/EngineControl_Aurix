...
/*                                                                            */
/* !Module          : look2_iu8lfts16p2If_binlcs                              */
/*                                                                            */
/* !File            : look2_iu8lfts16p2If_binlcs.c                            */
/*                                                                            */
...
Float32 look2_iu8lfts16p2If_binlcs(UInt8 localu0, UInt8 localu1, const
  UInt8 localbp0[], const UInt8 localbp1[], const SInt16 localtable[],
  const UInt32 localmaxIndex[], UInt32 localstride)
{
  ...
  localfrac = (((((Float32)localtable[localmaxIndex0 + 1U]) * 5.0F) -
                (((Float32)localyL_0d0) * 5.0F)) * localfractions[0]) +
    (((Float32)localyL_0d0) * 5.0F);
  localmaxIndex0 = localmaxIndex0 + localstride;
  localyL_0d0 = localtable[localmaxIndex0];
  localy = ((((((((Float32)localtable[localmaxIndex0 + 1U]) * 5.0F) -
                (((Float32)localyL_0d0) * 5.0F)) * localfractions[0]) +
              (((Float32)localyL_0d0) * 5.0F)) - localfrac) * localfractions[1])
    + localfrac;
  return localy;
}
