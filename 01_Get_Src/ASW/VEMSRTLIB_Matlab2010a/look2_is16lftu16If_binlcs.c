...
/*                                                                            */
/* !Module          : look2_is16lftu16If_binlcs                               */
/*                                                                            */
/* !File            : look2_is16lftu16If_binlcs.c                             */
/*                                                                            */
...
/*   Code generated on: Sun Mar 17 11:34:20 2013                              */
/******************************************************************************/
/* PVCS Information                                                           */
/* $Archive::   P:/ACT_EMS/LOG/REF/SWC_VEMS/VEMSRTLIB/Matlab2010a/look2_is16l$*/
/* $Revision::   1.0                                                         $*/
/* $Author::   adelvare                               $$Date::   03 Apr 2013 $*/
/******************************************************************************/
/* !CompReq : FLOAT                                                           */
/******************************************************************************/
#include "rtwtypes.h"
...
Float32 look2_is16lftu16If_binlcs(SInt16 localu0, SInt16 localu1, const
  ...
  const UInt32 localmaxIndex[], UInt32 localstride)
{
  ...
  localfrac = ((((Float32)localtable[localmaxIndex0 + 1U]) - ((Float32)
    localyL_0d0)) * localfractions[0]) + ((Float32)localyL_0d0);
  localmaxIndex0 = localmaxIndex0 + localstride;
  localyL_0d0 = localtable[localmaxIndex0];
  localy = (((((((Float32)localtable[localmaxIndex0 + 1U]) - ((Float32)
    localyL_0d0)) * localfractions[0]) + ((Float32)localyL_0d0)) - localfrac) *
