...
/*                                                                            */
/* !Module          : look2_iu16u8lftu8n7If_binlcns                           */
/*                                                                            */
/* !File            : look2_iu16u8lftu8n7If_binlcns.c                         */
/*                                                                            */
...
Float32 look2_iu16u8lftu8n7If_binlcns(UInt16 localu0, UInt8 localu1, const
  UInt16 localbp0[], const UInt8 localbp1[], const UInt8 localtable[],
  const UInt32 localmaxIndex[], UInt32 localstride)
{
  ...
  if (localu1 <= localbp1[0U]) {
    ...
    localfrac = ((Float32)((UInt8)(((UInt32)localu1) - ((UInt32)
      localbpLeftVar_0)))) / ((Float32)((UInt8)(((UInt32)
  ...
  localfrac = (((((Float32)localtable[localmaxIndex0 + 1U]) * 0.0078125F) -
                (((Float32)localbpLeftVar_0) * 0.0078125F)) * localfractions[0])
    + (((Float32)localbpLeftVar_0) * 0.0078125F);
  localmaxIndex0 = localmaxIndex0 + localstride;
  localbpLeftVar_0 = localtable[localmaxIndex0];
  localy = ((((((((Float32)localtable[localmaxIndex0 + 1U]) * 0.0078125F) -
                (((Float32)localbpLeftVar_0) * 0.0078125F)) * localfractions[0])
              + (((Float32)localbpLeftVar_0) * 0.0078125F)) - localfrac) *
