...
/*                                                                            */
/* !Module          : look2_iu16s16lfts16p3If_binlcs                          */
/*                                                                            */
/* !File            : look2_iu16s16lfts16p3If_binlcs.c                        */
/*                                                                            */
...
Float32 look2_iu16s16lfts16p3If_binlcs(UInt16 localu0, SInt16 localu1, const
  ...
  const UInt32 localmaxIndex[], UInt32 localstride)
{
  ...
  localfrac = ((((((Float32)localtable[localmaxIndex0 + 1U]) * 8.0F) + 4.0F) -
                ((((Float32)localbpLeftVar_0) * 8.0F) + 4.0F)) *
               localfractions[0]) + ((((Float32)localbpLeftVar_0) * 8.0F) +
    4.0F);
  ...
  localy = (((((((((Float32)localtable[localmaxIndex0 + 1U]) * 8.0F) + 4.0F) -
                ((((Float32)localbpLeftVar_0) * 8.0F) + 4.0F)) *
               localfractions[0]) + ((((Float32)localbpLeftVar_0) * 8.0F) +
    4.0F)) - localfrac) * localfractions[1]) + localfrac;
  return localy;
}
