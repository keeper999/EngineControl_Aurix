...
/*                                                                            */
/* !Module          : intrp2d_iu8n3ff_u32f_l_ns                               */
/*                                                                            */
/* !File            : intrp2d_iu8n3ff_u32f_l_ns.c                             */
/*                                                                            */
...
Float32 intrp2d_iu8n3ff_u32f_l_ns(const UInt32 localbpIndex[], const Float32
  localfrac[], const UInt8 localtable[], UInt32 localstride)
{
  ...
  localyL_1d = (((((Float32)localtable[localoffset_1d + 1U]) *
                  2.000000030E-001F) - (((Float32)localyL_0d0) *
    2.000000030E-001F)) * localfrac[0]) + (((Float32)localyL_0d0) *
    2.000000030E-001F);
  localoffset_1d = localoffset_1d + localstride;
  localyL_0d0 = localtable[localoffset_1d];
  localy = ((((((((Float32)localtable[localoffset_1d + 1U]) * 2.000000030E-001F)
                - (((Float32)localyL_0d0) * 2.000000030E-001F)) * localfrac[0])
              + (((Float32)localyL_0d0) * 2.000000030E-001F)) - localyL_1d) *
