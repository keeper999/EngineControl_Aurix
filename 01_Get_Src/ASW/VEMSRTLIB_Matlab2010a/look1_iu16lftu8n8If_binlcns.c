...
/*                                                                            */
/* !Module          : look1_iu16lftu8n8If_binlcns                             */
/*                                                                            */
/* !File            : look1_iu16lftu8n8If_binlcns.c                           */
/*                                                                            */
...
Float32 look1_iu16lftu8n8If_binlcns(UInt16 localu0, const UInt16 localbp0[],
  const UInt8 localtable[], UInt32 localmaxIndex)
{
  ...
  localy = ((((((Float32)localtable[localiLeft + 1U]) * 0.00390625F) +
              0.00390625F) - ((((Float32)localyL_0d0) * 0.00390625F) +
              0.00390625F)) * localfrac) + ((((Float32)localyL_0d0) *
