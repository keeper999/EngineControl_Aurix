...
/*                                                                            */
/* !Module          : look2_iu16u16lfts32n9If_binlcns                         */
/*                                                                            */
/* !File            : look2_iu16u16lfts32n9If_binlcns.c                       */
/*                                                                            */
...
Float32 look2_iu16u16lfts32n9If_binlcns(UInt16 localu0, UInt16 localu1,
  const UInt16 localbp0[], const UInt16 localbp1[], const SInt32
  localtable[], const UInt32 localmaxIndex[], UInt32 localstride)
{
  ...
  localfrac = (((((Float32)localtable[localmaxIndex0 + 1U]) * 0.001953125F) -
                (((Float32)localyL_0d0) * 0.001953125F)) * localfractions[0]) +
    (((Float32)localyL_0d0) * 0.001953125F);
  localmaxIndex0 = localmaxIndex0 + localstride;
  localyL_0d0 = localtable[localmaxIndex0];
  localy = ((((((((Float32)localtable[localmaxIndex0 + 1U]) * 0.001953125F) -
                (((Float32)localyL_0d0) * 0.001953125F)) * localfractions[0]) +
