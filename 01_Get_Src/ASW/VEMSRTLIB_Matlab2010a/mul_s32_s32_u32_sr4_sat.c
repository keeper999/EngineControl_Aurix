...
/*                                                                            */
/* !Module          : mul_s32_s32_u32_sr4_sat                                 */
/*                                                                            */
/* !File            : mul_s32_s32_u32_sr4_sat.c                               */
/*                                                                            */
...
/*   Code generated on: Fri Oct 28 14:43:58 2011                              */
/******************************************************************************/
/* PVCS Information                                                           */
...
SInt32 mul_s32_s32_u32_sr4_sat(SInt32 locala, UInt32 localb)
{
  SInt32 localresult;
  UInt32 localu32_chi;
  UInt32 localu32_clo;
  mul_wide_su32(locala, localb, &localu32_chi, &localu32_clo);
  localu32_clo = (UInt32)((localu32_chi << 28) | (localu32_clo >> 4));
  localu32_chi = (UInt32)(((SInt32)localu32_chi) >> 4);
