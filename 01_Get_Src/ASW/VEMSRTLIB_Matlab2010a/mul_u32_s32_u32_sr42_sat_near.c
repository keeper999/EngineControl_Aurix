...
/*                                                                            */
/* !Module          : mul_u32_s32_u32_sr42_sat_near                           */
/*                                                                            */
/* !File            : mul_u32_s32_u32_sr42_sat_near.c                         */
/*                                                                            */
...
UInt32 mul_u32_s32_u32_sr42_sat_near(SInt32 locala, UInt32 localb)
{
  UInt32 localresult;
  UInt32 localu32_chi;
  UInt32 localu32_clo;
  ...
  localu32_roundup = (UInt32)((localu32_chi & 512U) != 0);
  localtmp = (SInt32)localu32_chi;
  localu32_clo = ((UInt32)((localtmp >= 0) ? ((SInt32)(((UInt32)localtmp) >>
    10)) : (~((SInt32)(((UInt32)(~localtmp)) >> 10))))) + localu32_roundup;
