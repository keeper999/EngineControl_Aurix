...
/*                                                                            */
/* !Module          : mul_u32_u32_u32_sr5_sat_near                            */
/*                                                                            */
/* !File            : mul_u32_u32_u32_sr5_sat_near.c                          */
/*                                                                            */
...
UInt32 mul_u32_u32_u32_sr5_sat_near(UInt32 locala, UInt32 localb)
{
  UInt32 localresult;
  UInt32 localu32_chi;
  UInt32 localu32_clo;
  ...
  localu32_roundup = (UInt32)((localu32_clo & 16U) != 0);
  localu32_clo = ((UInt32)((localu32_chi << 27) | (localu32_clo >> 5))) +
    localu32_roundup;
