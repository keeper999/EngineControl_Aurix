...
/*                                                                            */
/* !File            : mul_s32_s32_s32_sr13_sat_zero.c                         */
/*                                                                            */
...
SInt32 mul_s32_s32_s32_sr13_sat_zero(SInt32 locala, SInt32 localb)
{
  SInt32 localresult;
  UInt32 localu32_chi;
  UInt32 localu32_clo;
  ...
  localu32_roundup = (UInt32)((((SInt32)localu32_chi) < 0) && (localu32_clo &
    8191U));
  localu32_clo = ((UInt32)((localu32_chi << 19) | (localu32_clo >> 13))) +
    localu32_roundup;
  localtmp = (SInt32)localu32_chi;
  localu32_chi = ((UInt32)((localu32_roundup) && (localu32_clo == ((UInt32)0))))
    + ((UInt32)((localtmp >= 0) ? ((SInt32)(((UInt32)localtmp) >> 13)) :
                  (~((SInt32)(((UInt32)(~localtmp)) >> 13)))));
