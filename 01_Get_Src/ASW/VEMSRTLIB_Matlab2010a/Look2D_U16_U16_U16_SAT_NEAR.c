...
/*                                                                            */
/* !File            : Look2D_U16_U16_U16_SAT_NEAR.c                           */
/*                                                                            */
...
/*********************************************************************
 * Lookup 2D Lookup Utility Look2D_U16_U16_U16_SAT_NEAR
 */
void Look2D_U16_U16_U16_SAT_NEAR( UInt16 *pY, const UInt16 *pYData, UInt16
  ...
  *pU1Data, UInt32 iHiU1)
{
...

  {
     ...
     */
    INTERPOLATE_U16_U16_SAT_NEAR( pY, yLeftLeft, yLeftRght, u1, u1Left, u1Rght);

    /* Interpolate along U1 variable
     *    with the u0 variable locked on the right u0
     */
    INTERPOLATE_U16_U16_SAT_NEAR( (&(yTemp)), yRghtLeft, yRghtRght, u1, u1Left,
      u1Rght);
...
/* end function Look2D_U16_U16_U16_SAT_NEAR
 *********************************************************************/
