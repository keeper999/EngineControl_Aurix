...
SInt8 div_s8s32_ceiling(SInt32 localnumerator, SInt32 localdenominator)
{
  SInt8 localquotient;
  ...
  if (localdenominator == 0) {
    localquotient = (localnumerator >= 0) ? MAX_int8_T : MIN_int8_T;
    ...
    localquotient = localquotientNeedsNegation ? ((SInt8)(-((SInt32)
      localtempAbsQuotient))) : ((SInt8)localtempAbsQuotient);
  }
