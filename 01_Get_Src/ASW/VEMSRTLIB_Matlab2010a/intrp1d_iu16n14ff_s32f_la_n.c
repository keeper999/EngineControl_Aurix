...
Float32 intrp1d_iu16n14ff_s32f_la_n(SInt32 localbpIndex, Float32 localfrac,
  const UInt16 localtable[], UInt32 localmaxIndex)
{
  ...
  if (((UInt32)localbpIndex) == localmaxIndex) {
    localy = ((Float32)localtable[localoffset_0d]) * 9.155273438E-005F;
  } else {
    localyL_0d0 = localtable[localoffset_0d];
    localy = (((((Float32)localtable[localoffset_0d + 1U]) * 9.155273438E-005F)
