...
/*                                                                            */
/* !Module          : look2_iu16s16lfts16n4If_binlcns                         */
/*                                                                            */
/* !File            : look2_iu16s16lfts16n4If_binlcns.c                       */
/*                                                                            */
...
/*   Code generated on: Wed Jul 25 14:41:48 2012                              */
/******************************************************************************/
/* PVCS Information                                                           */
...
Float32 look2_iu16s16lfts16n4If_binlcns(UInt16 localu0, SInt16 localu1,
  const UInt16 localbp0[], const SInt16 localbp1[], const SInt16 localtable[],
  const UInt32 localmaxIndex[], UInt32 localstride)
{
  ...
  localfrac = (((((Float32)localtable[localmaxIndex0 + 1U]) * 0.0625F) -
                (((Float32)localbpLeftVar_0) * 0.0625F)) * localfractions[0]) +
    (((Float32)localbpLeftVar_0) * 0.0625F);
  localmaxIndex0 = localmaxIndex0 + localstride;
  localbpLeftVar_0 = localtable[localmaxIndex0];
  localy = ((((((((Float32)localtable[localmaxIndex0 + 1U]) * 0.0625F) -
                (((Float32)localbpLeftVar_0) * 0.0625F)) * localfractions[0]) +
              (((Float32)localbpLeftVar_0) * 0.0625F)) - localfrac) *
