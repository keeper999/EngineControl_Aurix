...
/*                                                                            */
/* !Module          : intrp2d_iu16n7ff_u32f_l_ns__1                              */
/*                                                                            */
/* !File            : intrp2d_iu16n7ff_u32f_l_ns__1.c                            */
/*                                                                            */
...
Float32 intrp2d_iu16n7ff_u32f_l_ns__1(const UInt32 localbpIndex[], const
  Float32 localfrac[], const UInt16 localtable[], UInt32 localstride)
{
  ...
  localyL_1d = (((((Float32)localtable[localoffset_1d + 1U]) *
                  9.999999776E-003F) - (((Float32)localyL_0d0) *
    9.999999776E-003F)) * localfrac[0]) + (((Float32)localyL_0d0) *
    9.999999776E-003F);
  localoffset_1d = localoffset_1d + localstride;
  localyL_0d0 = localtable[localoffset_1d];
  localy = ((((((((Float32)localtable[localoffset_1d + 1U]) * 9.999999776E-003F)
                - (((Float32)localyL_0d0) * 9.999999776E-003F)) * localfrac[0])
              + (((Float32)localyL_0d0) * 9.999999776E-003F)) - localyL_1d) *
