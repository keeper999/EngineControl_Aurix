...
/*                                                                            */
/* !Module          : intrp2d_iu16n14ff_s32f_la_n                             */
/*                                                                            */
/* !File            : intrp2d_iu16n14ff_s32f_la_n.c                           */
/*                                                                            */
...
Float32 intrp2d_iu16n14ff_s32f_la_n(const SInt32 localbpIndex[], const
  ...
  UInt32 localmaxIndex[])
{
  ...
  if (((UInt32)localbpIndex[0]) == localmaxIndex[0]) {
    localyL_1d = ((Float32)localtable[localoffset_1d]) * 7.629394531E-005F;
  } else {
    localyL_0d0 = localtable[localoffset_1d];
    localyL_1d = (((((Float32)localtable[localoffset_1d + 1U]) *
                    7.629394531E-005F) - (((Float32)localyL_0d0) *
      7.629394531E-005F)) * localfrac[0]) + (((Float32)localyL_0d0) *
      7.629394531E-005F);
  }
  ...
  if (((UInt32)localbpIndex[1]) == localmaxIndex[1]) {
    ...
    if (((UInt32)localbpIndex[0]) == localmaxIndex[0]) {
      localyR_1d = ((Float32)localtable[localoffset_1d]) * 7.629394531E-005F;
    } else {
      localyL_0d0 = localtable[localoffset_1d];
