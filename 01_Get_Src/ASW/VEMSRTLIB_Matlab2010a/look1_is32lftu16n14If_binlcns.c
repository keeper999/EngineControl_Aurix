...
/*                                                                            */
/* !Module          : look1_is32lftu16n14If_binlcns                           */
/*                                                                            */
/* !File            : look1_is32lftu16n14If_binlcns.c                         */
/*                                                                            */
...
Float32 look1_is32lftu16n14If_binlcns(SInt32 localu0, const SInt32 localbp0[],
  const UInt16 localtable[], UInt32 localmaxIndex)
{
  ...
  localy = (((((Float32)localtable[localiLeft + 1U]) * 6.103515625E-005F) -
             (((Float32)localyL_0d0) * 6.103515625E-005F)) * localfrac) +
    (((Float32)localyL_0d0) * 6.103515625E-005F);
  return localy;
}
