...
/*                                                                            */
/* !Module          : look2_1fc22bc2bcvbfbbr64fbbnx                           */
/*                                                                            */
/* !File            : look2_1fc22bc2bcvbfbbr64fbbnx.c                         */
/*                                                                            */
...
Float32 look2_1fc22bc2bcvbfbbr64fbbnx(UInt16 localu0, SInt16 localu1, const
  ...
  const UInt32 localmaxIndex[], UInt32 localstride)
{
  ...
  /* Lookup 2-D
     Canonical function name: look2_iu16s16lftu16n13If_binlcns
  ...
  localfrac = (((((Float32)localtable[localmaxIndex0 + 1U]) * 2.288818359E-004F)
                - (((Float32)localbpLeftVar) * 2.288818359E-004F)) *
  ...
  localy = ((((((((Float32)localtable[localmaxIndex0 + 1U]) * 2.288818359E-004F)
                - (((Float32)localbpLeftVar) * 2.288818359E-004F)) *
               localfractions[0]) + (((Float32)localbpLeftVar) *
    2.288818359E-004F)) - localfrac) * localfractions[1]) + localfrac;
  return localy;
}
