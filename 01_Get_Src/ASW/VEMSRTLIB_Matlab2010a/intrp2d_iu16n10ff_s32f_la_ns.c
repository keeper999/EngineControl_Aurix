...
/*                                                                            */
/* !Module          : intrp2d_iu16n10ff_s32f_la_ns                            */
/*                                                                            */
/* !File            : intrp2d_iu16n10ff_s32f_la_ns.c                          */
/*                                                                            */
...
Float32 intrp2d_iu16n10ff_s32f_la_ns(const SInt32 localbpIndex[], const
  ...
  UInt32 localmaxIndex[])
{
  ...
  if (((UInt32)localbpIndex[0]) == localmaxIndex[0]) {
    localyL_1d = ((Float32)localtable[localoffset_1d]) * 1.000000047E-003F;
  } else {
  ...
  if (((UInt32)localbpIndex[1]) == localmaxIndex[1]) {
    ...
    if (((UInt32)localbpIndex[0]) == localmaxIndex[0]) {
      localyR_1d = ((Float32)localtable[localoffset_1d]) * 1.000000047E-003F;
    } else {
      localyL_0d0 = localtable[localoffset_1d];
