...
/*                                                                            */
/* !Module          : look1_is32lftu16p9If_binlcs                             */
/*                                                                            */
/* !File            : look1_is32lftu16p9If_binlcs.c                           */
/*                                                                            */
...
Float32 look1_is32lftu16p9If_binlcs(SInt32 localu0, const SInt32 localbp0[],
  const UInt16 localtable[], UInt32 localmaxIndex)
{
  ...
  localy = (((((Float32)localtable[localiLeft + 1U]) * 781.25F) - (((Float32)
    localyL_0d0) * 781.25F)) * localfrac) + (((Float32)localyL_0d0) * 781.25F);
  return localy;
}
