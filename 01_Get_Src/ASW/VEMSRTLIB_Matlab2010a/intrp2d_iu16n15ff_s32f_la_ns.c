...
/*                                                                            */
/* !Module          : intrp2d_iu16n15ff_s32f_la_ns                            */
/*                                                                            */
/* !File            : intrp2d_iu16n15ff_s32f_la_ns.c                          */
/*                                                                            */
...
Float32 intrp2d_iu16n15ff_s32f_la_ns(const SInt32 localbpIndex[], const
  ...
  UInt32 localmaxIndex[])
{
  ...
  if (((UInt32)localbpIndex[0]) == localmaxIndex[0]) {
    localyL_1d = ((Float32)localtable[localoffset_1d]) * 3.051757813E-005F;
  } else {
    localyL_0d0 = localtable[localoffset_1d];
    localyL_1d = (((((Float32)localtable[localoffset_1d + 1U]) *
                    3.051757813E-005F) - (((Float32)localyL_0d0) *
      3.051757813E-005F)) * localfrac[0]) + (((Float32)localyL_0d0) *
      3.051757813E-005F);
  }
  ...
  if (((UInt32)localbpIndex[1]) == localmaxIndex[1]) {
    ...
    if (((UInt32)localbpIndex[0]) == localmaxIndex[0]) {
      localyR_1d = ((Float32)localtable[localoffset_1d]) * 3.051757813E-005F;
    } else {
      localyL_0d0 = localtable[localoffset_1d];
