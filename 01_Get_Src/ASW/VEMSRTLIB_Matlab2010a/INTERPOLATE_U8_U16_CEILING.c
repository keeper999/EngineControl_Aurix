...
/*                                                                            */
/* !Module          : INTERPOLATE_U8_U16_CEILING                              */
/*                                                                            */
/* !File            : INTERPOLATE_U8_U16_CEILING.c                            */
/*                                                                            */
...
/*********************************************************************
 * Lookup Interpolation INTERPOLATE_U8_U16_CEILING
 */
void INTERPOLATE_U8_U16_CEILING( UInt8 *pY, UInt8 yL, UInt8 yR, UInt16 x,
  UInt16 xL, UInt16 xR)
{
  UInt32 bigProd;
  UInt8 yDiff;
  ...
  *pY = yL;
  ...
  if ((xR > xL) && (x > xL) ) {
    ...
    yDiff = (UInt8)div_u32_ceiling(bigProd, (UInt32)xDen);
    if (yR >= yL ) {
...
/* end INTERPOLATE_U8_U16_CEILING
 *********************************************************************/
