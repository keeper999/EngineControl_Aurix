...
/*                                                                            */
/* !Module          : look2_iu8u16lftu16n12If_binlcns                         */
/*                                                                            */
/* !File            : look2_iu8u16lftu16n12If_binlcns.c                       */
/*                                                                            */
...
Float32 look2_iu8u16lftu16n12If_binlcns(UInt8 localu0, UInt16 localu1,
  const UInt8 localbp0[], const UInt16 localbp1[], const UInt16
  localtable[], const UInt32 localmaxIndex[], UInt32 localstride)
{
  ...
  localfrac = (((((Float32)localtable[localmaxIndex0 + 1U]) * 0.000244140625F)
                - (((Float32)localbpLeftVar_0) * 0.000244140625F)) *
  ...
  localy = ((((((((Float32)localtable[localmaxIndex0 + 1U]) * 0.000244140625F)
                - (((Float32)localbpLeftVar_0) * 0.000244140625F)) *
               localfractions[0]) + (((Float32)localbpLeftVar_0) *
    0.000244140625F)) - localfrac) * localfractions[1]) + localfrac;
  return localy;
}
