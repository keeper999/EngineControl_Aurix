...
/*                                                                            */
/* !Module          : look2_iu16lftu16n4If_binlcns                            */
/*                                                                            */
/* !File            : look2_iu16lftu16n4If_binlcns.c                          */
/*                                                                            */
...
/******************************************************************************/
/* PVCS Information                                                           */
/* $Archive::   P:/ACT_EMS/LOG/REF/SWC_VEMS/VEMSRTLIB/Matlab2010a/look2_iu16l$*/
/* $Revision::   1.0                                                         $*/
/* $Author::   adelvare                               $$Date::   25 Oct 2012 $*/
/******************************************************************************/
/* !CompReq : FLOAT                                                           */
/******************************************************************************/
#include "rtwtypes.h"
...
Float32 look2_iu16lftu16n4If_binlcns(UInt16 localu0, UInt16 localu1, const
  ...
  const UInt32 localmaxIndex[], UInt32 localstride)
{
  ...
  localfrac = (((((Float32)localtable[localmaxIndex0 + 1U]) * 1.000000015E-001F)
                - (((Float32)localbpLeftVar) * 1.000000015E-001F)) *
               localfractions[0]) + (((Float32)localbpLeftVar) *
    1.000000015E-001F);
  localmaxIndex0 = localmaxIndex0 + localstride;
  localbpLeftVar = localtable[localmaxIndex0];
  localy = ((((((((Float32)localtable[localmaxIndex0 + 1U]) * 1.000000015E-001F)
                - (((Float32)localbpLeftVar) * 1.000000015E-001F)) *
               localfractions[0]) + (((Float32)localbpLeftVar) *
    1.000000015E-001F)) - localfrac) * localfractions[1]) + localfrac;
  return localy;
}
