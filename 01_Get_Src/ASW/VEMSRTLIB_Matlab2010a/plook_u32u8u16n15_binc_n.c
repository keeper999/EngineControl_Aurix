...
/*                                                                            */
/* !Module          : plook_u32u8u16n15_binc_n                                */
/*                                                                            */
/* !File            : plook_u32u8u16n15_binc_n.c                              */
/*                                                                            */
...
UInt32 plook_u32u8u16n15_binc_n(UInt8 localu, const UInt8 localbp[],
  UInt32 localmaxIndex, UInt16 *localfraction)
{
  ...
  if (localu <= localbp[0U]) {
    ...
    *localfraction = (UInt16)div_u32_near(((UInt32)((UInt8)(((UInt32)
      localu) - ((UInt32)localbpLeftVar)))) << 15U, (UInt32)((UInt8)
