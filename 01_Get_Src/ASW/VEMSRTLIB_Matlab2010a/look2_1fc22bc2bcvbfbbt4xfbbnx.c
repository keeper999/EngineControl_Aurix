...
/*                                                                            */
/* !Module          : look2_1fc22bc2bcvbfbbt4xfbbnx                           */
/*                                                                            */
/* !File            : look2_1fc22bc2bcvbfbbt4xfbbnx.c                         */
/*                                                                            */
...
Float32 look2_1fc22bc2bcvbfbbt4xfbbnx(UInt16 localu0, SInt16 localu1, const
  ...
  const UInt32 localmaxIndex[], UInt32 localstride)
{
  ...
  /* Lookup 2-D
     Canonical function name: look2_iu16s16lfts16n22If_binlcns
  ...
  localfrac = (((((Float32)localtable[localmaxIndex0 + 1U]) * 3.051757744E-007F)
                - (((Float32)localbpLeftVar_0) * 3.051757744E-007F)) *
               localfractions[0]) + (((Float32)localbpLeftVar_0) *
    3.051757744E-007F);
  localmaxIndex0 = localmaxIndex0 + localstride;
  localbpLeftVar_0 = localtable[localmaxIndex0];
  localy = ((((((((Float32)localtable[localmaxIndex0 + 1U]) * 3.051757744E-007F)
                - (((Float32)localbpLeftVar_0) * 3.051757744E-007F)) *
               localfractions[0]) + (((Float32)localbpLeftVar_0) *
    3.051757744E-007F)) - localfrac) * localfractions[1]) + localfrac;
  return localy;
}
