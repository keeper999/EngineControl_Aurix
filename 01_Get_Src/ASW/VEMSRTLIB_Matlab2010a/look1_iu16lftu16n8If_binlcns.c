...
/*                                                                            */
/* !Module          : look1_iu16lftu16n8If_binlcns                            */
/*                                                                            */
/* !File            : look1_iu16lftu16n8If_binlcns.c                          */
/*                                                                            */
...
Float32 look1_iu16lftu16n8If_binlcns(UInt16 localu0, const UInt16 localbp0[],
  const UInt16 localtable[], UInt32 localmaxIndex)
{
  ...
  localy = (((((Float32)localtable[localiLeft + 1U]) * 3.921508789E-003F) -
             (((Float32)localbpLeftVar) * 3.921508789E-003F)) * localfrac) +
    (((Float32)localbpLeftVar) * 3.921508789E-003F);
  return localy;
}
