...
/*                                                                            */
/* !Module          : look2_iu16u16lftu16n1If_binlcns                         */
/*                                                                            */
/* !File            : look2_iu16u16lftu16n1If_binlcns.c                       */
/*                                                                            */
...
Float32 look2_iu16u16lftu16n1If_binlcns(UInt16 localu0, UInt16 localu1,
  ...
  localtable[], const UInt32 localmaxIndex[], UInt32 localstride)
{
  ...
  localfrac = (((((Float32)localtable[localmaxIndex0 + 1U]) * 0.5F) -
                (((Float32)localbpLeftVar) * 0.5F)) * localfractions[0]) +
    (((Float32)localbpLeftVar) * 0.5F);
  localmaxIndex0 = localmaxIndex0 + localstride;
  localbpLeftVar = localtable[localmaxIndex0];
  localy = ((((((((Float32)localtable[localmaxIndex0 + 1U]) * 0.5F) -
                (((Float32)localbpLeftVar) * 0.5F)) * localfractions[0]) +
              (((Float32)localbpLeftVar) * 0.5F)) - localfrac) *
