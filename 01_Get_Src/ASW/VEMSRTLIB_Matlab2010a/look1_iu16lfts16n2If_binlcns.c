...
/*                                                                            */
/* !Module          : look1_iu16lfts16n2If_binlcns                            */
/*                                                                            */
/* !File            : look1_iu16lfts16n2If_binlcns.c                          */
/*                                                                            */
...
/*   Code generated on: Wed Oct 17 12:54:00 2012                              */
/******************************************************************************/
/* PVCS Information                                                           */
...
Float32 look1_iu16lfts16n2If_binlcns(UInt16 localu0, const UInt16 localbp0[],
  const SInt16 localtable[], UInt32 localmaxIndex)
{
  ...
  localy = (((((Float32)localtable[localiLeft + 1U]) * 0.25F) - (((Float32)
    localyL_0d0) * 0.25F)) * localfrac) + (((Float32)localyL_0d0) * 0.25F);
  return localy;
}
