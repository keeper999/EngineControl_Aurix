...
/*                                                                            */
/* !Module          : look1_iu8lftu8n2If_binlcns                              */
/*                                                                            */
/* !File            : look1_iu8lftu8n2If_binlcns.c                            */
/*                                                                            */
...
Float32 look1_iu8lftu8n2If_binlcns(UInt8 localu0, const UInt8 localbp0[],
  const UInt8 localtable[], UInt32 localmaxIndex)
{
  ...
  localy = (((((Float32)localtable[localiLeft + 1U]) * 0.25F) - (((Float32)
    localbpLeftVar) * 0.25F)) * localfrac) + (((Float32)localbpLeftVar) * 0.25F);
  return localy;
}
