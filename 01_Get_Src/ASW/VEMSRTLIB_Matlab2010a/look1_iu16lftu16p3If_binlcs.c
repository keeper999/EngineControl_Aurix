...
/*                                                                            */
/* !Module          : look1_iu16lftu16p3If_binlcs                             */
/*                                                                            */
/* !File            : look1_iu16lftu16p3If_binlcs.c                           */
/*                                                                            */
...
Float32 look1_iu16lftu16p3If_binlcs(UInt16 localu0, const UInt16 localbp0[],
  const UInt16 localtable[], UInt32 localmaxIndex)
{
  ...
  localy = (((((Float32)localtable[localiLeft + 1U]) * 8.0F) - (((Float32)
    localbpLeftVar) * 8.0F)) * localfrac) + (((Float32)localbpLeftVar) * 8.0F);
  return localy;
}
