...
/*                                                                            */
/* !Module          : mul_s32_s32_s32_sr26_sat                                */
/*                                                                            */
/* !File            : mul_s32_s32_s32_sr26_sat.c                              */
/*                                                                            */
...
/*   Code generated on: Wed Aug 24 11:58:10 2011                              */
/******************************************************************************/
/* PVCS Information                                                           */
/* $Archive::   P:/ACT_EMS/LOG/REF/SWC_VEMS/VEMSRTLIB/Matlab2010a/mul_s32_s32$*/
/* $Revision::   1.0                                                         $*/
/* $Author::   ADELVARE                               $$Date::   25 Aug 2011 $*/
/******************************************************************************/
/* !CompReq : FLOAT                                                           */
/******************************************************************************/
#include "rtwtypes.h"
...
SInt32 mul_s32_s32_s32_sr26_sat(SInt32 locala, SInt32 localb)
{
  SInt32 localresult;
  UInt32 localu32_chi;
  UInt32 localu32_clo;
  mul_wide_s32(locala, localb, &localu32_chi, &localu32_clo);
  localu32_clo = (UInt32)((localu32_chi << 6) | (localu32_clo >> 26));
  localu32_chi = (UInt32)(((SInt32)localu32_chi) >> 26);
