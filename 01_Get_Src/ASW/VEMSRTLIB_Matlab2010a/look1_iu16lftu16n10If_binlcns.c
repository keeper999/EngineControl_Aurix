...
/*                                                                            */
/* !Module          : look1_iu16lftu16n10If_binlcns                           */
/*                                                                            */
/* !File            : look1_iu16lftu16n10If_binlcns.c                         */
/*                                                                            */
...
Float32 look1_iu16lftu16n10If_binlcns(UInt16 localu0, const UInt16
  localbp0[], const UInt16 localtable[], UInt32 localmaxIndex)
{
  ...
  localy = (((((Float32)localtable[localiLeft + 1U]) * 0.0009765625F) -
             (((Float32)localbpLeftVar) * 0.0009765625F)) * localfrac) +
    (((Float32)localbpLeftVar) * 0.0009765625F);
  return localy;
}
