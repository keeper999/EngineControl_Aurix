...
/*                                                                            */
/* !Module          : look1_iu16lftu16n14If_binlcns                           */
/*                                                                            */
/* !File            : look1_iu16lftu16n14If_binlcns.c                         */
/*                                                                            */
...
Float32 look1_iu16lftu16n14If_binlcns(UInt16 localu0, const UInt16
  localbp0[], const UInt16 localtable[], UInt32 localmaxIndex)
{
  ...
  localy = (((((Float32)localtable[localiLeft + 1U]) * 6.103515625E-005F) -
             (((Float32)localbpLeftVar) * 6.103515625E-005F)) * localfrac) +
