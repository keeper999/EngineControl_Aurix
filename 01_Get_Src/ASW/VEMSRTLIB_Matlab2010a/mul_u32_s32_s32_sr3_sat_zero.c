...
/*                                                                            */
/* !File            : mul_u32_s32_s32_sr3_sat_zero.c                          */
/*                                                                            */
...
UInt32 mul_u32_s32_s32_sr3_sat_zero(SInt32 locala, SInt32 localb)
{
  UInt32 localresult;
  UInt32 localu32_chi;
  UInt32 localu32_clo;
  ...
  localu32_roundup = ((((SInt32)localu32_chi) < 0) && (localu32_clo & 7U));
  localu32_clo = ((UInt32)((localu32_chi << 29) | (localu32_clo >> 3))) +
    localu32_roundup;
  localu32_chi = ((UInt32)((localu32_roundup) && (localu32_clo == ((UInt32)0))))
    + ((UInt32)(((SInt32)localu32_chi) >> 3));
