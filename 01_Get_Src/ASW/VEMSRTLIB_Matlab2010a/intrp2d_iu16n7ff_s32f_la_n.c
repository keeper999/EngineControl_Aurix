...
/*                                                                            */
/* !Module          : intrp2d_iu16n7ff_s32f_la_n                              */
/*                                                                            */
/* !File            : intrp2d_iu16n7ff_s32f_la_n.c                            */
/*                                                                            */
...
Float32 intrp2d_iu16n7ff_s32f_la_n(const SInt32 localbpIndex[], const Float32
  ...
  localmaxIndex[])
{
  ...
  if (((UInt32)localbpIndex[0]) == localmaxIndex[0]) {
    localyL_1d = ((Float32)localtable[localoffset_1d]) * 1.525878906E-002F;
  } else {
    localyL_0d0 = localtable[localoffset_1d];
    localyL_1d = (((((Float32)localtable[localoffset_1d + 1U]) *
                    1.525878906E-002F) - (((Float32)localyL_0d0) *
      1.525878906E-002F)) * localfrac[0]) + (((Float32)localyL_0d0) *
      1.525878906E-002F);
  }
  ...
  if (((UInt32)localbpIndex[1]) == localmaxIndex[1]) {
    ...
    if (((UInt32)localbpIndex[0]) == localmaxIndex[0]) {
      localyR_1d = ((Float32)localtable[localoffset_1d]) * 1.525878906E-002F;
    } else {
      localyL_0d0 = localtable[localoffset_1d];
