...
/*                                                                            */
/* !Module          : look1_iu16lftu16n13If_binlcns                           */
/*                                                                            */
/* !File            : look1_iu16lftu16n13If_binlcns.c                         */
/*                                                                            */
...
Float32 look1_iu16lftu16n13If_binlcns(UInt16 localu0, const UInt16
  localbp0[], const UInt16 localtable[], UInt32 localmaxIndex)
{
  ...
  localy = (((((Float32)localtable[localiLeft + 1U]) * 2.288818359E-004F) -
             (((Float32)localbpLeftVar) * 2.288818359E-004F)) * localfrac) +
