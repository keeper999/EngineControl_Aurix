...
/*                                                                            */
/* !Module          : look1_is16lftu16n7If_binlcns                            */
/*                                                                            */
/* !File            : look1_is16lftu16n7If_binlcns.c                          */
/*                                                                            */
...
/*   Code generated on: Mon Feb 11 17:41:09 2013                              */
/******************************************************************************/
/* PVCS Information                                                           */
...
Float32 look1_is16lftu16n7If_binlcns(SInt16 localu0, const SInt16 localbp0[],
  const UInt16 localtable[], UInt32 localmaxIndex)
{
  ...
  localy = ((((((Float32)localtable[localiLeft + 1U]) * 0.0078125F) + 223.0F) -
             ((((Float32)localyL_0d0) * 0.0078125F) + 223.0F)) * localfrac) +
    ((((Float32)localyL_0d0) * 0.0078125F) + 223.0F);
  return localy;
}
