...
/*                                                                            */
/* !Module          : intrp2d_iu16n5ff_u32f_l_ns                              */
/*                                                                            */
/* !File            : intrp2d_iu16n5ff_u32f_l_ns.c                            */
/*                                                                            */
...
Float32 intrp2d_iu16n5ff_u32f_l_ns(const UInt32 localbpIndex[], const
  Float32 localfrac[], const UInt16 localtable[], UInt32 localstride)
{
  ...
  localyL_1d = ((((((Float32)localtable[localoffset_1d + 1U]) * 0.03125F) +
                ...
                localfrac[0]) + ((((Float32)localyL_0d0) * 0.03125F) + 223.0F);
  localoffset_1d = localoffset_1d + localstride;
  localyL_0d0 = localtable[localoffset_1d];
  localy = (((((((((Float32)localtable[localoffset_1d + 1U]) * 0.03125F) +
                 223.0F) - ((((Float32)localyL_0d0) * 0.03125F) + 223.0F)) *
               localfrac[0]) + ((((Float32)localyL_0d0) * 0.03125F) + 223.0F))
