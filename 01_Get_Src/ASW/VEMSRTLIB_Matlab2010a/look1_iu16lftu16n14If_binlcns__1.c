...
/*                                                                            */
/* !Module          : look1_iu16lftu16n14If_binlcns__1                           */
/*                                                                            */
/* !File            : look1_iu16lftu16n14If_binlcns__1.c                         */
/*                                                                            */
...
Float32 look1_iu16lftu16n14If_binlcns__1(UInt16 localu0, const UInt16
  localbp0[], const UInt16 localtable[], UInt32 localmaxIndex)
{
  ...
  localy = (((((Float32)localtable[localiLeft + 1U]) * 9.999999747E-005F) -
             (((Float32)localbpLeftVar) * 9.999999747E-005F)) * localfrac) +
    (((Float32)localbpLeftVar) * 9.999999747E-005F);
  return localy;
}
