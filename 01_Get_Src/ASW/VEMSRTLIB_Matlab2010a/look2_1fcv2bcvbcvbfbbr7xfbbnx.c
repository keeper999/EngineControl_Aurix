...
/*                                                                            */
/* !Module          : look2_1fcv2bcvbcvbfbbr7xfbbnx                           */
/*                                                                            */
/* !File            : look2_1fcv2bcvbcvbfbbr7xfbbnx.c                         */
/*                                                                            */
...
/*   Code generated on: Thu Jan 10 17:24:34 2013                              */
/******************************************************************************/
/* PVCS Information                                                           */
/* $Archive::   P:/ACT_EMS/LOG/REF/SWC_VEMS/VEMSRTLIB/Matlab2010a/look2_1fcv2$*/
/* $Revision::   1.0                                                         $*/
/* $Author::   adelvare                               $$Date::   14 Jan 2013 $*/
/******************************************************************************/
/* !CompReq : FLOAT                                                           */
/******************************************************************************/
#include "rtwtypes.h"
...
Float32 look2_1fcv2bcvbcvbfbbr7xfbbnx(UInt16 localu0, UInt16 localu1, const
  ...
  const UInt32 localmaxIndex[], UInt32 localstride)
{
  ...
  /* Lookup 2-D
     Canonical function name: look2_iu16u16lftu16n10If_binlcns
  ...
  localfrac = (((((Float32)localtable[localmaxIndex0 + 1U]) * 1.525878906E-003F)
                - (((Float32)localbpLeftVar) * 1.525878906E-003F)) *
               localfractions[0]) + (((Float32)localbpLeftVar) *
    1.525878906E-003F);
  localmaxIndex0 = localmaxIndex0 + localstride;
  localbpLeftVar = localtable[localmaxIndex0];
  localy = ((((((((Float32)localtable[localmaxIndex0 + 1U]) * 1.525878906E-003F)
                - (((Float32)localbpLeftVar) * 1.525878906E-003F)) *
               localfractions[0]) + (((Float32)localbpLeftVar) *
    1.525878906E-003F)) - localfrac) * localfractions[1]) + localfrac;
  return localy;
}
