...
/*                                                                            */
/* !Module          : mul_u32_u32_u32_sr39_near                               */
/*                                                                            */
/* !File            : mul_u32_u32_u32_sr39_near.c                             */
/*                                                                            */
...
UInt32 mul_u32_u32_u32_sr39_near(UInt32 locala, UInt32 localb)
{
  UInt32 localresult;
  UInt32 localu32_chi;
  UInt32 localu32_clo;
  mul_wide_u32(locala, localb, &localu32_chi, &localu32_clo);
  localu32_clo = ((UInt32)((localu32_chi & 64U) != 0)) + (localu32_chi >> 7);
