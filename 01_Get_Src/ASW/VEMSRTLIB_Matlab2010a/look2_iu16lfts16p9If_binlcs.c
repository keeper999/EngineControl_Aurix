...
/*                                                                            */
/* !Module          : look2_iu16lfts16p9If_binlcs                             */
/*                                                                            */
/* !File            : look2_iu16lfts16p9If_binlcs.c                           */
/*                                                                            */
...
Float32 look2_iu16lfts16p9If_binlcs(UInt16 localu0, UInt16 localu1, const
  UInt16 localbp0[], const UInt16 localbp1[], const SInt16 localtable[],
  const UInt32 localmaxIndex[], UInt32 localstride)
{
  ...
  localfrac = (((((Float32)localtable[localmaxIndex0 + 1U]) * 781.25F) -
                (((Float32)localyL_0d0) * 781.25F)) * localfractions[0]) +
    (((Float32)localyL_0d0) * 781.25F);
  localmaxIndex0 = localmaxIndex0 + localstride;
  localyL_0d0 = localtable[localmaxIndex0];
  localy = ((((((((Float32)localtable[localmaxIndex0 + 1U]) * 781.25F) -
                (((Float32)localyL_0d0) * 781.25F)) * localfractions[0]) +
              (((Float32)localyL_0d0) * 781.25F)) - localfrac) *
