...
/*                                                                            */
/* !Module          : look2_is16s32lfts16n6If_binlcns                         */
/*                                                                            */
/* !File            : look2_is16s32lfts16n6If_binlcns.c                       */
/*                                                                            */
...
/******************************************************************************/
/* PVCS Information                                                           */
/* $Archive::   P:/ACT_EMS/LOG/REF/SWC_VEMS/VEMSRTLIB/Matlab2010a/look2_is16s$*/
/* $Revision::   1.0                                                         $*/
...
Float32 look2_is16s32lfts16n6If_binlcns(SInt16 localu0, SInt32 localu1, const
  SInt16 localbp0[], const SInt32 localbp1[], const SInt16 localtable[],
  const UInt32 localmaxIndex[], UInt32 localstride)
{
  ...
  if (localu1 <= localbp1[0U]) {
    ...
    localfrac = (Float32)(((Float32d)(((UInt32)localu1) - ((UInt32)
      localbpLeftVar_0))) / ((Float32d)(((UInt32)localbp1[localiLeft + 1U]) -
      ((UInt32)localbpLeftVar_0))));
  } else {
