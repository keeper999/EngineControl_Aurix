...
/*                                                                            */
/* !Module          : look2_iu16u16lftu16n4If_binlcns                         */
/*                                                                            */
/* !File            : look2_iu16u16lftu16n4If_binlcns.c                       */
/*                                                                            */
...
Float32 look2_iu16u16lftu16n4If_binlcns(UInt16 localu0, UInt16 localu1,
  ...
  localtable[], const UInt32 localmaxIndex[], UInt32 localstride)
{
  ...
  localfrac = (((((Float32)localtable[localmaxIndex0 + 1U]) * 0.09375F) -
                (((Float32)localbpLeftVar) * 0.09375F)) * localfractions[0]) +
    (((Float32)localbpLeftVar) * 0.09375F);
  localmaxIndex0 = localmaxIndex0 + localstride;
  localbpLeftVar = localtable[localmaxIndex0];
  localy = ((((((((Float32)localtable[localmaxIndex0 + 1U]) * 0.09375F) -
                (((Float32)localbpLeftVar) * 0.09375F)) * localfractions[0]) +
              (((Float32)localbpLeftVar) * 0.09375F)) - localfrac) *
