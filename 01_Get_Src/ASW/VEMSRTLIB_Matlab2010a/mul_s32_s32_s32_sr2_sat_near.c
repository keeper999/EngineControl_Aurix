...
/*                                                                            */
/* !Module          : mul_s32_s32_s32_sr2_sat_near                            */
/*                                                                            */
/* !File            : mul_s32_s32_s32_sr2_sat_near.c                          */
/*                                                                            */
...
SInt32 mul_s32_s32_s32_sr2_sat_near(SInt32 locala, SInt32 localb)
{
  SInt32 localresult;
  UInt32 localu32_chi;
  UInt32 localu32_clo;
  ...
  localu32_roundup = (UInt32)((localu32_clo & 2U) != 0);
  localu32_clo = ((UInt32)((localu32_chi << 30) | (localu32_clo >> 2))) +
    localu32_roundup;
  localtmp = (SInt32)localu32_chi;
  localu32_chi = ((UInt32)((localu32_roundup) && (localu32_clo == ((UInt32)0))))
    + ((UInt32)((localtmp >= 0) ? ((SInt32)(((UInt32)localtmp) >> 2)) :
                  (~((SInt32)(((UInt32)(~localtmp)) >> 2)))));
