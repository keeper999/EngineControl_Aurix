...
/*                                                                            */
/* !Module          : look1_is16lftu16p1If_binlcs                             */
/*                                                                            */
/* !File            : look1_is16lftu16p1If_binlcs.c                           */
/*                                                                            */
...
Float32 look1_is16lftu16p1If_binlcs(SInt16 localu0, const SInt16 localbp0[],
  const UInt16 localtable[], UInt32 localmaxIndex)
{
  ...
  localy = (((((Float32)localtable[localiLeft + 1U]) * 2.0F) - (((Float32)
    localyL_0d0) * 2.0F)) * localfrac) + (((Float32)localyL_0d0) * 2.0F);
  return localy;
}
