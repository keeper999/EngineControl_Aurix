...
/*                                                                            */
/* !Module          : look2_1fcv2bcvbcvbfbbr7dfbbnx                           */
/*                                                                            */
/* !File            : look2_1fcv2bcvbcvbfbbr7dfbbnx.c                         */
/*                                                                            */
...
Float32 look2_1fcv2bcvbcvbfbbr7dfbbnx(UInt16 localu0, UInt16 localu1, const
  ...
  const UInt32 localmaxIndex[], UInt32 localstride)
{
  ...
  /* Lookup 2-D
     Canonical function name: look2_iu16u16lftu16n12If_binlcns
  ...
  localfrac = (((((Float32)localtable[localmaxIndex0 + 1U]) * 0.000244140625F)
                - (((Float32)localbpLeftVar) * 0.000244140625F)) *
