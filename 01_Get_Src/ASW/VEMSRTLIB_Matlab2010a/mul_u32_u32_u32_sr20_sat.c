...
/*                                                                            */
/* !Module          : mul_u32_u32_u32_sr20_sat                                */
/*                                                                            */
/* !File            : mul_u32_u32_u32_sr20_sat.c                              */
/*                                                                            */
...
UInt32 mul_u32_u32_u32_sr20_sat(UInt32 locala, UInt32 localb)
{
  UInt32 localresult;
  UInt32 localu32_chi;
  UInt32 localu32_clo;
  mul_wide_u32(locala, localb, &localu32_chi, &localu32_clo);
  localu32_clo = (UInt32)((localu32_chi << 12) | (localu32_clo >> 20));
  localu32_chi = (localu32_chi >> 20);
  if (localu32_chi) {
