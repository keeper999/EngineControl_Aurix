...
/*                                                                            */
/* !Module          : look2_is8s8lftu16n13If_binlcns                          */
/*                                                                            */
/* !File            : look2_is8s8lftu16n13If_binlcns.c                        */
/*                                                                            */
...
/******************************************************************************/
/* PVCS Information                                                           */
/* $Archive::   P:/ACT_EMS/LOG/REF/SWC_VEMS/VEMSRTLIB/Matlab2010a/look2_is8s8$*/
/* $Revision::   1.0                                                         $*/
...
Float32 look2_is8s8lftu16n13If_binlcns(SInt8 localu0, SInt8 localu1, const
  SInt8 localbp0[], const SInt8 localbp1[], const UInt16 localtable[], const
  UInt32 localmaxIndex[], UInt32 localstride)
{
  Float32 localy;
  ...
  if (localu0 <= localbp0[0U]) {
    ...
    localfrac = ((Float32)((UInt8)(((UInt32)localu0) - ((UInt32)
      localbpLeftVar)))) / ((Float32)((UInt8)(localbp0[localiLeft + 1U] -
      localbpLeftVar)));
  } else {
  ...
  if (localu1 <= localbp1[0U]) {
    ...
    localfrac = ((Float32)((UInt8)(((UInt32)localu1) - ((UInt32)
      localbpLeftVar)))) / ((Float32)((UInt8)(localbp1[localiLeft + 1U] -
      localbpLeftVar)));
  } else {
  ...
  localfrac = (((((Float32)localtable[localmaxIndex0 + 1U]) * 2.288818359E-004F)
                - (((Float32)localyL_0d0) * 2.288818359E-004F)) *
               localfractions[0]) + (((Float32)localyL_0d0) * 2.288818359E-004F);
  localmaxIndex0 = localmaxIndex0 + localstride;
  localyL_0d0 = localtable[localmaxIndex0];
  localy = ((((((((Float32)localtable[localmaxIndex0 + 1U]) * 2.288818359E-004F)
                - (((Float32)localyL_0d0) * 2.288818359E-004F)) *
               localfractions[0]) + (((Float32)localyL_0d0) * 2.288818359E-004F))
