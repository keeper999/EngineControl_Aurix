...
/*                                                                            */
/* !Module          : look2_1fcv2bcvbcvbfbbr6xfbbnx                           */
/*                                                                            */
/* !File            : look2_1fcv2bcvbcvbfbbr6xfbbnx.c                         */
/*                                                                            */
...
/*   Code generated on: Sun Apr 07 12:48:59 2013                              */
/******************************************************************************/
/* PVCS Information                                                           */
...
Float32 look2_1fcv2bcvbcvbfbbr6xfbbnx(UInt16 localu0, UInt16 localu1, const
  ...
  const UInt32 localmaxIndex[], UInt32 localstride)
{
  ...
  /* Lookup 2-D
     Canonical function name: look2_iu16u16lftu16n14If_binlcns
  ...
  localfrac = (((((Float32)localtable[localmaxIndex0 + 1U]) * 6.103515625E-005F)
                - (((Float32)localbpLeftVar) * 6.103515625E-005F)) *
               localfractions[0]) + (((Float32)localbpLeftVar) *
    6.103515625E-005F);
  localmaxIndex0 = localmaxIndex0 + localstride;
  localbpLeftVar = localtable[localmaxIndex0];
  localy = ((((((((Float32)localtable[localmaxIndex0 + 1U]) * 6.103515625E-005F)
                - (((Float32)localbpLeftVar) * 6.103515625E-005F)) *
               localfractions[0]) + (((Float32)localbpLeftVar) *
    6.103515625E-005F)) - localfrac) * localfractions[1]) + localfrac;
  return localy;
}
