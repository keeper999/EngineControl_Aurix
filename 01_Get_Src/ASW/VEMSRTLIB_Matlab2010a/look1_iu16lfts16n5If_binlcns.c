...
/*                                                                            */
/* !Module          : look1_iu16lfts16n5If_binlcns                            */
/*                                                                            */
/* !File            : look1_iu16lfts16n5If_binlcns.c                          */
/*                                                                            */
...
/*   Code generated on: Wed Oct 24 11:48:46 2012                              */
/******************************************************************************/
/* PVCS Information                                                           */
...
Float32 look1_iu16lfts16n5If_binlcns(UInt16 localu0, const UInt16 localbp0[],
  const SInt16 localtable[], UInt32 localmaxIndex)
{
  Float32 localy;
  Float32 localfrac;
  ...
  localy = (((((Float32)localtable[localiLeft + 1U]) * 0.03125F) - (((Float32)
    localyL_0d0) * 0.03125F)) * localfrac) + (((Float32)localyL_0d0) * 0.03125F);
  return localy;
}
