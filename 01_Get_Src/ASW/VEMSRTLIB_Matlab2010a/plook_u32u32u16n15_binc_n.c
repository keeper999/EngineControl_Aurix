...
/*                                                                            */
/* !Module          : plook_u32u32u16n15_binc_n                               */
/*                                                                            */
/* !File            : plook_u32u32u16n15_binc_n.c                             */
/*                                                                            */
...
UInt32 plook_u32u32u16n15_binc_n(UInt32 localu, const UInt32 localbp[],
  UInt32 localmaxIndex, UInt16 *localfraction)
{
  ...
  if (localu <= localbp[0U]) {
    ...
    *localfraction = (UInt16)div_repeat_u32_near(localu - localbpLeftVar,
      localbp[localbpIndex + 1U] - localbpLeftVar, 15U);
  } else {
