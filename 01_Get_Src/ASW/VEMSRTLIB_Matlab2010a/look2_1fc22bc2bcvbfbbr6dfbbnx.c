...
/*                                                                            */
/* !Module          : look2_1fc22bc2bcvbfbbr6dfbbnx                           */
/*                                                                            */
/* !File            : look2_1fc22bc2bcvbfbbr6dfbbnx.c                         */
/*                                                                            */
...
Float32 look2_1fc22bc2bcvbfbbr6dfbbnx(UInt16 localu0, SInt16 localu1, const
  UInt16 localbp0[], const SInt16 localbp1[], const UInt16 localtable[],
  const UInt32 localmaxIndex[], UInt32 localstride)
{
  ...
  /* Lookup 2-D
     Canonical function name: look2_iu16s16lftu16n16If_binlcns
  ...
  localfrac = (((((Float32)localtable[localmaxIndex0 + 1U]) * 1.525878906E-005F)
                - (((Float32)localbpLeftVar) * 1.525878906E-005F)) *
  ...
  localy = ((((((((Float32)localtable[localmaxIndex0 + 1U]) * 1.525878906E-005F)
                - (((Float32)localbpLeftVar) * 1.525878906E-005F)) *
               localfractions[0]) + (((Float32)localbpLeftVar) *
    1.525878906E-005F)) - localfrac) * localfractions[1]) + localfrac;
  return localy;
}
