...
/*                                                                            */
/* !Module          : look2_1fc22bc2bcvbfbbr6nfbbnx                           */
/*                                                                            */
/* !File            : look2_1fc22bc2bcvbfbbr6nfbbnx.c                         */
/*                                                                            */
...
Float32 look2_1fc22bc2bcvbfbbr6nfbbnx(UInt16 localu0, SInt16 localu1, const
  ...
  const UInt32 localmaxIndex[], UInt32 localstride)
{
  ...
  /* Lookup 2-D
     Canonical function name: look2_iu16s16lftu16n15If_binlcns
  ...
  localfrac = (((((Float32)localtable[localmaxIndex0 + 1U]) * 3.051757813E-005F)
                - (((Float32)localbpLeftVar) * 3.051757813E-005F)) *
               localfractions[0]) + (((Float32)localbpLeftVar) *
    3.051757813E-005F);
  localmaxIndex0 = localmaxIndex0 + localstride;
  localbpLeftVar = localtable[localmaxIndex0];
  localy = ((((((((Float32)localtable[localmaxIndex0 + 1U]) * 3.051757813E-005F)
                - (((Float32)localbpLeftVar) * 3.051757813E-005F)) *
               localfractions[0]) + (((Float32)localbpLeftVar) *
    3.051757813E-005F)) - localfrac) * localfractions[1]) + localfrac;
  return localy;
}
