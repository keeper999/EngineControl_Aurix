...
Float32 intrp2d_iu16n16ff_u32f_l_ns(const UInt32 localbpIndex[], const
  Float32 localfrac[], const UInt16 localtable[], UInt32 localstride)
{
  ...
  localyL_0d0 = localtable[localoffset_1d];
  localy = ((((((((Float32)localtable[localoffset_1d + 1U]) * 1.525878906E-005F)
                - (((Float32)localyL_0d0) * 1.525878906E-005F)) * localfrac[0])
              + (((Float32)localyL_0d0) * 1.525878906E-005F)) - localyL_1d) *
