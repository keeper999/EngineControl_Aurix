...
/*                                                                            */
/* !Module          : look1_is32lftu8n8If_binlcns                             */
/*                                                                            */
/* !File            : look1_is32lftu8n8If_binlcns.c                           */
/*                                                                            */
...
Float32 look1_is32lftu8n8If_binlcns(SInt32 localu0, const SInt32 localbp0[],
  const UInt8 localtable[], UInt32 localmaxIndex)
{
  ...
  localy = (((((Float32)localtable[localiLeft + 1U]) * 0.00390625F) -
             (((Float32)localyL_0d0) * 0.00390625F)) * localfrac) + (((Float32)
    localyL_0d0) * 0.00390625F);
  return localy;
}
