...
/*                                                                            */
/* !Module          : look1_iu16lfts32n16If_binlcns                           */
/*                                                                            */
/* !File            : look1_iu16lfts32n16If_binlcns.c                         */
/*                                                                            */
...
/*   Code generated on: Tue Jul 10 14:54:54 2012                              */
/******************************************************************************/
/* PVCS Information                                                           */
...
Float32 look1_iu16lfts32n16If_binlcns(UInt16 localu0, const UInt16
  localbp0[], const SInt32 localtable[], UInt32 localmaxIndex)
{
  Float32 localy;
  Float32 localfrac;
  ...
  localy = (((((Float32)localtable[localiLeft + 1U]) * 1.953124956E-005F) -
             (((Float32)localyL_0d0) * 1.953124956E-005F)) * localfrac) +
    (((Float32)localyL_0d0) * 1.953124956E-005F);
  return localy;
}
