...
/*                                                                            */
/* !Module          : Look2D_S32_S16_U16                                      */
/*                                                                            */
/* !File            : Look2D_S32_S16_U16.c                                    */
/*                                                                            */
...
/*********************************************************************
 * Lookup 2D Lookup Utility Look2D_S32_S16_U16
 */
void Look2D_S32_S16_U16( SInt32 *pY, const SInt32 *pYData, SInt16 u0, const
  ...
  UInt32 iHiU1)
{
...

  {
    ...
    if (u0Rght > u0Left ) {
      ...
      SInt16 den;
      den = u0Rght;
      den = (SInt16)(den - u0Left);
      num = u0;
      num = (SInt16)(num - u0Left);
      u0Lambda = div_repeat_us32_floor(num << 16U, (SInt32)den, (UInt32)15);
    } else {
      u0Lambda = 0U;
    }
...
/* end function Look2D_S32_S16_U16
 *********************************************************************/
