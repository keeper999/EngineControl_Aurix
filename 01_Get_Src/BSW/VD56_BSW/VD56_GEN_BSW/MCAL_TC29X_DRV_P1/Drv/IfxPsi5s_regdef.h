...
typedef struct _Ifx_PSI5S_GCR_Bits
{
    ...
    unsigned int CEN3:1;                    /**< \brief [19:19] Enable Channel x (rw) */
    unsigned int CEN4:1;                    /**< \brief [20:20] Enable Channel x (rw) */
...
typedef volatile struct _Ifx_PSI5S
{
    ...
    Ifx_PSI5S_FDR FDR;                      /**< \brief C, SMU Fractional Divider Register */
    ...
    Ifx_PSI5S_RCRA RCRA[5];                 /**< \brief 30, Receiver Control Register A */
    unsigned char reserved_44[12];          /**< \brief 44, \internal Reserved */
    Ifx_PSI5S_RCRB RCRB[5];                 /**< \brief 50, Receiver Control Register B */
    unsigned char reserved_64[12];          /**< \brief 64, \internal Reserved */
    Ifx_PSI5S_WDT WDT[5];                   /**< \brief 70, Watch Dog Timer Register */
    unsigned char reserved_84[12];          /**< \brief 84, \internal Reserved */
    Ifx_PSI5S_TSCR TSCR[5];                 /**< \brief 90, Capture Register */
    ...
    Ifx_PSI5S_PGC PGC[5];                   /**< \brief F0, Pulse Generation Control Register */
    unsigned char reserved_104[12];         /**< \brief 104, \internal Reserved */
    Ifx_PSI5S_CTV CTV[5];                   /**< \brief 110, Channel Trigger Value Register */
    unsigned char reserved_124[12];         /**< \brief 124, \internal Reserved */
    Ifx_PSI5S_SCR SCR[5];                   /**< \brief 130, Send Control Register */
    unsigned char reserved_144[12];         /**< \brief 144, \internal Reserved */
    Ifx_PSI5S_SDR SDR[5];                   /**< \brief 150, Send Data Register */
    ...
    Ifx_PSI5S_INTSTAT INTSTAT[5];           /**< \brief 260, Interrupt Status Register */
    unsigned char reserved_274[12];         /**< \brief 274, \internal Reserved */
    Ifx_PSI5S_INTSET INTSET[5];             /**< \brief 280, Interrupt Set Register */
    unsigned char reserved_294[12];         /**< \brief 294, \internal Reserved */
    Ifx_PSI5S_INTCLR INTCLR[5];             /**< \brief 2A0, Interrupt Clear Register */
    unsigned char reserved_2B4[12];         /**< \brief 2B4, \internal Reserved */
    Ifx_PSI5S_INTEN INTEN[5];               /**< \brief 2C0, Interrupt Enable Register */
    unsigned char reserved_2D4[12];         /**< \brief 2D4, \internal Reserved */
    Ifx_PSI5S_INP INP[5];                   /**< \brief 2E0, Interrupt Node Pointer Register */
