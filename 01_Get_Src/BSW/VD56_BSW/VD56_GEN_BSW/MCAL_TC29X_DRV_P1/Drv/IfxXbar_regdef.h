...
typedef struct _Ifx_XBAR_IDINTEN_Bits
{
    ...
    unsigned int ENSCI10:1;                 /**< \brief [10:10] Enable ID Error from SCIn (rw) */
    unsigned int reserved_11:4;             /**< \brief \internal Reserved */
...
{
    unsigned int IDCSCI0:1;                 /**< \brief [0:0] Transaction ID Error from SCIn Status (rwh) */
    unsigned int IDCSCI1:1;                 /**< \brief [1:1] Transaction ID Error from SCIn Status (rwh) */
    unsigned int IDCSCI2:1;                 /**< \brief [2:2] Transaction ID Error from SCIn Status (rwh) */
    unsigned int reserved_3:1;              /**< \brief \internal Reserved */
    ...
    unsigned int IDSCI10:1;                 /**< \brief [10:10] Transaction ID Error from SCIn Status (rwh) */
    unsigned int reserved_11:4;             /**< \brief \internal Reserved */
...
typedef struct _Ifx_XBAR_INTSAT_Bits
{
    ...
    unsigned int SCSCI10:1;                 /**< \brief [10:10] Starvation Error from SCIn Status (rwh) */
    unsigned int reserved_11:4;             /**< \brief \internal Reserved */
    ...
    unsigned int PRSCI10:1;                 /**< \brief [26:26] Protocol Error from SCIn Status (rwh) */
