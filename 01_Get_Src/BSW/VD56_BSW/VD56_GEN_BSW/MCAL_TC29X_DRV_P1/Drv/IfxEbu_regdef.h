...
{
    Ifx_Strict_32Bit DISR:1;                /**< \brief [0:0] EBU Disable Request BitWhile the DISR bit is implemented in the EBU, it connects to the standby logic which will disable the clock tree. Standby mode will be exited automatically when an attempt is made to access the EBU. (rw) */
    Ifx_Strict_32Bit DISS:1;                /**< \brief [1:1] EBU Disable Status Bit (r) */
    Ifx_Strict_32Bit reserved_2:6;          /**< \brief \internal Reserved */
    Ifx_Strict_32Bit EPE:1;                 /**< \brief [8:8] Endinit Protection EnableThis register can be Endinit-protected after initialization. Writing to this register in this state will cause the EBU to generate an SRI Error. (rw) */
