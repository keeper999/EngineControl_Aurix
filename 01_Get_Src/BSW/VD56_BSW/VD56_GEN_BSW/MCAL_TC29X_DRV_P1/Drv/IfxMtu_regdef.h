...
typedef struct _Ifx_MTU_MEMSTAT0_Bits
{
    ...
    unsigned int HSMxAIU:3;                 /**< \brief [25:23] Reserved in this product (r) */
...
typedef struct _Ifx_MTU_MEMTEST1_Bits
{
    ...
    unsigned int EMEML8EN:1;                /**< \brief [22:22] EMEM Lower x (TCM) MBIST Controller Memory Test Enable (ED only) (rwh) */
    unsigned int EMEML9EN:1;                /**< \brief [23:23] EMEM Lower x (TCM) MBIST Controller Memory Test Enable (ED only) (rwh) */
    unsigned int EMEML10EN:1;               /**< \brief [24:24] EMEM Lower x (TCM) MBIST Controller Memory Test Enable (ED only) (rwh) */
    unsigned int EMEML11EN:1;               /**< \brief [25:25] EMEM Lower x (TCM) MBIST Controller Memory Test Enable (ED only) (rwh) */
    unsigned int EMEML12EN:1;               /**< \brief [26:26] EMEM Lower x (TCM) MBIST Controller Memory Test Enable (ED only) (rwh) */
    unsigned int EMEML13EN:1;               /**< \brief [27:27] EMEM Lower x (TCM) MBIST Controller Memory Test Enable (ED only) (rwh) */
    unsigned int EMEML14EN:1;               /**< \brief [28:28] EMEM Lower x (TCM) MBIST Controller Memory Test Enable (ED only) (rwh) */
    unsigned int EMEML15EN:1;               /**< \brief [29:29] EMEM Lower x (TCM) MBIST Controller Memory Test Enable (ED only) (rwh) */
...
{
    unsigned int EMEMU2EN:1;                /**< \brief [0:0] EMEM Upper x (XCM) Controller Memory Test Enable (rwh) */
    unsigned int EMEMU3EN:1;                /**< \brief [1:1] EMEM Upper x (XCM) Controller Memory Test Enable (rwh) */
    unsigned int EMEMU4EN:1;                /**< \brief [2:2] EMEM Upper x (XCM) Controller Memory Test Enable (rwh) */
    unsigned int EMEMU5EN:1;                /**< \brief [3:3] EMEM Upper x (XCM) Controller Memory Test Enable (rwh) */
    unsigned int EMEMU6EN:1;                /**< \brief [4:4] EMEM Upper x (XCM) Controller Memory Test Enable (rwh) */
    unsigned int EMEMU7EN:1;                /**< \brief [5:5] EMEM Upper x (XCM) Controller Memory Test Enable (rwh) */
    unsigned int EMEMU8EN:1;                /**< \brief [6:6] EMEM Upper x (XCM) Controller Memory Test Enable (rwh) */
    unsigned int EMEMU9EN:1;                /**< \brief [7:7] EMEM Upper x (XCM) Controller Memory Test Enable (rwh) */
    unsigned int EMEMU10EN:1;               /**< \brief [8:8] EMEM Upper x (XCM) Controller Memory Test Enable (rwh) */
    unsigned int EMEMU11EN:1;               /**< \brief [9:9] EMEM Upper x (XCM) Controller Memory Test Enable (rwh) */
    unsigned int EMEMU12EN:1;               /**< \brief [10:10] EMEM Upper x (XCM) Controller Memory Test Enable (rwh) */
    unsigned int EMEMU13EN:1;               /**< \brief [11:11] EMEM Upper x (XCM) Controller Memory Test Enable (rwh) */
    unsigned int EMEMU14EN:1;               /**< \brief [12:12] EMEM Upper x (XCM) Controller Memory Test Enable (rwh) */
    unsigned int EMEMU15EN:1;               /**< \brief [13:13] EMEM Upper x (XCM) Controller Memory Test Enable (rwh) */
