...
{
    unsigned int reserved_0:1;              /**< \brief \internal Reserved */
    unsigned int SEL1:1;                    /**< \brief [1:1] Output Select for Pin x (rw) */
    unsigned int SEL2:1;                    /**< \brief [2:2] Pin Controller or Output Select for Pin 2 (rw) */
    unsigned int SEL3:1;                    /**< \brief [3:3] Pin Controller or Output Select for Pin 3 (rw) */
    unsigned int SEL4:1;                    /**< \brief [4:4] Output Select for Pin x (rw) */
    unsigned int SEL5:1;                    /**< \brief [5:5] Output Select for Pin x (rw) */
    unsigned int SEL6:1;                    /**< \brief [6:6] Pin Controller or Output Select for Pin 6 (rw) */
    unsigned int reserved_7:3;              /**< \brief \internal Reserved */
    unsigned int SEL10:1;                   /**< \brief [10:10] Output Select for Pin x (rw) */
    unsigned int SEL11:1;                   /**< \brief [11:11] Output Select for Pin x (rw) */
...
/** \\brief  Port LVDS Pad Control Register 0
 * Port LVDS Pad Control Register 0
 */
typedef union
{
    /** \brief Unsigned access */
    ...
    /** \brief Signed access */
    signed int I;
    /** \brief Bitfield access: Port LVDS Pad Control Register 0 */
...
/** \\brief  Port LVDS Pad Control Register 2
 * Port LVDS Pad Control Register 2
 */
typedef union
{
    /** \brief Unsigned access */
    ...
    /** \brief Signed access */
    signed int I;
    /** \brief Bitfield access: Port LVDS Pad Control Register 2 */
