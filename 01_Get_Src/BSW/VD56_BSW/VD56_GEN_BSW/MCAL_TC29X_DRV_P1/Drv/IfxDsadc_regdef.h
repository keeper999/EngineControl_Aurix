...
typedef struct _Ifx_DSADC_ACCPROT_Bits
{
    ...
    unsigned int RG40:1;                    /**< \brief [16:16] Register Group x, Channels 4 - 9 (rw) */
    unsigned int RG41:1;                    /**< \brief [17:17] Register Group x, Channels 4 - 9 (rw) */
    unsigned int RG42:1;                    /**< \brief [18:18] Register Group x, Channels 4 - 9 (rw) */
    unsigned int RG43:1;                    /**< \brief [19:19] Register Group x, Channels 4 - 9 (rw) */
    unsigned int RG44:1;                    /**< \brief [20:20] Register Group x, Channels 4 - 9 (rw) */
...
typedef struct _Ifx_DSADC_GLOBCFG_Bits
{
    ...
    unsigned int IBSEL:4;                   /**< \brief [19:16] Bias Current SelectThis is a preset value. Do not change this value when writing to GLOBCFG, unless there is an explicit recommendation. (rw) */
...
{
    unsigned int CH0RUN:1;                  /**< \brief [0:0] Channel x Run Control (rw) */
    unsigned int CH1RUN:1;                  /**< \brief [1:1] Channel x Run Control (rw) */
    unsigned int CH2RUN:1;                  /**< \brief [2:2] Channel x Run Control (rw) */
    unsigned int CH3RUN:1;                  /**< \brief [3:3] Channel x Run Control (rw) */
    unsigned int CH4RUN:1;                  /**< \brief [4:4] Channel x Run Control (rw) */
    unsigned int CH5RUN:1;                  /**< \brief [5:5] Channel x Run Control (rw) */
    unsigned int CH6RUN:1;                  /**< \brief [6:6] Channel x Run Control (rw) */
    unsigned int CH7RUN:1;                  /**< \brief [7:7] Channel x Run Control (rw) */
    unsigned int CH8RUN:1;                  /**< \brief [8:8] Channel x Run Control (rw) */
    unsigned int CH9RUN:1;                  /**< \brief [9:9] Channel x Run Control (rw) */
    unsigned int reserved_10:6;             /**< \brief \internal Reserved */
    unsigned int M0RUN:1;                   /**< \brief [16:16] Modulator x Run Control (rw) */
    unsigned int M1RUN:1;                   /**< \brief [17:17] Modulator x Run Control (rw) */
    unsigned int M2RUN:1;                   /**< \brief [18:18] Modulator x Run Control (rw) */
    unsigned int M3RUN:1;                   /**< \brief [19:19] Modulator x Run Control (rw) */
    unsigned int M4RUN:1;                   /**< \brief [20:20] Modulator x Run Control (rw) */
    unsigned int M5RUN:1;                   /**< \brief [21:21] Modulator x Run Control (rw) */
    unsigned int M6RUN:1;                   /**< \brief [22:22] Modulator x Run Control (rw) */
    unsigned int M7RUN:1;                   /**< \brief [23:23] Modulator x Run Control (rw) */
    unsigned int M8RUN:1;                   /**< \brief [24:24] Modulator x Run Control (rw) */
    unsigned int M9RUN:1;                   /**< \brief [25:25] Modulator x Run Control (rw) */
    unsigned int reserved_26:6;             /**< \brief \internal Reserved */
...
{
    unsigned int IN8PVC0:1;                 /**< \brief [0:0] Voltage Control of Positive Inputs y of CH8 (rw) */
    unsigned int IN8PVC1:1;                 /**< \brief [1:1] Voltage Control of Positive Inputs y of CH8 (rw) */
    unsigned int reserved_2:2;              /**< \brief \internal Reserved */
    unsigned int IN8NVC0:1;                 /**< \brief [4:4] Voltage Control of Negative Inputs y of CH8 (rw) */
    unsigned int IN8NVC1:1;                 /**< \brief [5:5] Voltage Control of Negative Inputs y of CH8 (rw) */
