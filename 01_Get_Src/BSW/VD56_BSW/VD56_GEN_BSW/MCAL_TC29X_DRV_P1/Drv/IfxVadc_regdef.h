...
{
    unsigned int SEV0NP:4;                  /**< \brief [3:0] Service Request Node Pointer Source Event iSource 0 is an 8-stage queued source, source 1 is a channel scan source. (rw) */
    unsigned int SEV1NP:4;                  /**< \brief [7:4] Service Request Node Pointer Source Event iSource 0 is an 8-stage queued source, source 1 is a channel scan source. (rw) */
    unsigned int reserved_8:24;             /**< \brief \internal Reserved */
...
typedef struct _Ifx_VADC_SHS_CALGC_Bits
{
    ...
    unsigned int CALGNVALA:14;              /**< \brief [29:16] Gain Calibration Value, Alternate ReferenceGain calibration for the alternate reference is omitted from the calibration sequence, if bit CALCTR.ARCDIS is set. (rwh) */
    unsigned int reserved_30:1;             /**< \brief \internal Reserved */
...
typedef struct _Ifx_VADC_SHS_SHSCFG_Bits
{
    ...
    unsigned int reserved_4:1;              /**< \brief \internal Reserved */
    unsigned int SYNSH23:2;                 /**< \brief [6:5] Synchronization of Sample&Hold Units xySee section . (rw) */
    unsigned int SYNSH01:2;                 /**< \brief [8:7] Synchronization of Sample&Hold Units xySee section . (rw) */
...
typedef volatile struct _Ifx_VADC
{
    ...
    Ifx_VADC_SHS SHS[3];                    /**< \brief 5000, Group objects */
} Ifx_VADC;
/** \}  */
/******************************************************************************/
/** \}  */
