...
/* !Comment: DET Section allocation */
...
#elif defined   DET_START_SEC_VAR_POWER_ON_CLEARED_8BIT
   #undef  DET_START_SEC_VAR_POWER_ON_CLEARED_8BIT
   #define START_SEC_VAR_POWER_ON_CLEARED_8BIT_CPU2_SECTION
#elif defined   DET_STOP_SEC_VAR_POWER_ON_CLEARED_8BIT
   #undef  DET_STOP_SEC_VAR_POWER_ON_CLEARED_8BIT
   ...
   #define START_SEC_VAR_POWER_ON_CLEARED_BOOLEAN_CPU2_SECTION
#elif defined   DET_STOP_SEC_VAR_POWER_ON_CLEARED_BOOLEAN
   #undef  DET_STOP_SEC_VAR_POWER_ON_CLEARED_BOOLEAN
   #define STOP_SEC_VAR_POWER_ON_CLEARED_BOOLEAN_CPU2_SECTION
...
/* !Comment: SEC_VAR_POWER_ON_CLEARED_BOOLEAN Start Section treatment */
   #elif defined   START_SEC_VAR_POWER_ON_CLEARED_BOOLEAN_CPU2_SECTION
...
/* !Comment: SEC_VAR_POWER_ON_CLEARED_BOOLEAN Stop Section treatment */
   #elif defined   STOP_SEC_VAR_POWER_ON_CLEARED_BOOLEAN_CPU2_SECTION && defined  START_SEC_VAR_POWER_ON_CLEARED_BOOLEAN_CPU2_SECTION
	  

      #pragma section

      #undef START_SEC_VAR_POWER_ON_CLEARED_BOOLEAN_CPU2_SECTION
      #undef STOP_SEC_VAR_POWER_ON_CLEARED_BOOLEAN_CPU2_SECTION
      #undef MEMMAP_ERROR
      #undef MEMMAP_START_DONE
...
#if defined MEMMAP_ERROR
   #error MEMMAP-E201 : Bad memory allocation into DET_MemMap.h
#endif
