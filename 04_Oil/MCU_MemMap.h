...
/* !Comment: MCU Section allocation */
   ...
   #define START_SEC_SAFETY_CODE_SECTION
#elif defined   MCU_STOP_SEC_SAFETY_CODE
   #undef  MCU_STOP_SEC_SAFETY_CODE
   #define STOP_SEC_SAFETY_CODE_SECTION
...
/* !Comment: SEC_SAFETY_CODE Start Section treatment */
   #elif defined   START_SEC_SAFETY_CODE_SECTION
...
/* !Comment: SEC_SAFETY_CODE Stop Section treatment */
   #elif defined   STOP_SEC_SAFETY_CODE_SECTION && defined  START_SEC_SAFETY_CODE_SECTION
	  

      #pragma section

      #undef START_SEC_SAFETY_CODE_SECTION
      #undef STOP_SEC_SAFETY_CODE_SECTION
      #undef MEMMAP_ERROR
      #undef MEMMAP_START_DONE
...
#if defined MEMMAP_ERROR
   #error MEMMAP-E201 : Bad memory allocation into MCU_MemMap.h
#endif
