...
/* !Comment: FEE Section allocation */
...
/* !Comment: SEC_ILLEGALNOTIF_CODE Start Section treatment */
   #elif defined   START_SEC_ILLEGALNOTIF_CODE_SECTION
...
/* !Comment: SEC_JOBENDNOTIF_CODE Start Section treatment */
   #elif defined   START_SEC_JOBENDNOTIF_CODE_SECTION
...
/* !Comment: SEC_JOBERRNOTIF_CODE Start Section treatment */
   #elif defined   START_SEC_JOBERRNOTIF_CODE_SECTION
...
/* !Comment: SEC_SPL_VAR_32BIT Start Section treatment */
...
/* !Comment: SEC_ILLEGALNOTIF_CODE Stop Section treatment */
   #elif defined   STOP_SEC_ILLEGALNOTIF_CODE_SECTION && defined  START_SEC_ILLEGALNOTIF_CODE_SECTION
	  

      #pragma section

      #undef START_SEC_ILLEGALNOTIF_CODE_SECTION
      #undef STOP_SEC_ILLEGALNOTIF_CODE_SECTION
      #undef MEMMAP_ERROR
      #undef MEMMAP_START_DONE

/* !Comment: SEC_JOBENDNOTIF_CODE Stop Section treatment */
   #elif defined   STOP_SEC_JOBENDNOTIF_CODE_SECTION && defined  START_SEC_JOBENDNOTIF_CODE_SECTION
	  

      #pragma section

      #undef START_SEC_JOBENDNOTIF_CODE_SECTION
      #undef STOP_SEC_JOBENDNOTIF_CODE_SECTION
      #undef MEMMAP_ERROR
      #undef MEMMAP_START_DONE

/* !Comment: SEC_JOBERRNOTIF_CODE Stop Section treatment */
   #elif defined   STOP_SEC_JOBERRNOTIF_CODE_SECTION && defined  START_SEC_JOBERRNOTIF_CODE_SECTION
	  

      #pragma section

      #undef START_SEC_JOBERRNOTIF_CODE_SECTION
      #undef STOP_SEC_JOBERRNOTIF_CODE_SECTION
      #undef MEMMAP_ERROR
      #undef MEMMAP_START_DONE

/* !Comment: SEC_SPL_VAR_32BIT Stop Section treatment */
...
#if defined MEMMAP_ERROR
   #error MEMMAP-E201 : Bad memory allocation into FEE_MemMap.h
#endif
